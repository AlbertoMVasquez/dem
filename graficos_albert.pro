...
stop
goto,mapa
; analisis cuantitativo del cambio de Ne y Tm por correccion de los
; datos de AIA
  ldemfile='LDEM.v2_CR2099_l0.75_chianti.ioneq_sun_coronal_1992_feldman_ext.abund_AIA3_FullCorona_192_corregido_gauss1_lin_Norm-median_singlStart'
  read_ldem,ldemfile,/ldem,/gauss1
  Ne_2 = N_e
  Tm_2 = Tm
  ldemfile='LDEM.v2_CR2099_l0.75_chianti.ioneq_sun_coronal_1992_feldman_ext.abund_AIA3_FullCorona_192_gauss1_lin_Norm-median_singlStart'
  read_ldem,ldemfile,/ldem,/gauss1
  Ne_1 = N_e
  Tm_1 = Tm
  ir=7
  rNe = Ne_2/Ne_1 & rNe=reform(rNe(ir,*,*))
  rTm = Tm_2/Tm_1 & rTm=reform(rTm(ir,*,*))
  demc_aux = reform(demc(ir,*,*))
  i = where(demc_aux ne -999.)
  rNe = rNe(i)
  rTm = rTm(i)
  xmin=0.5
  xmax=1.5
  nb  =100
  fNe = histogram(rNe,min=xmin,max=xmax,nbins=nb,locations=xrat)  &  fNe = fNe / total(fNe)
  fTm = histogram(rTm,min=xmin,max=xmax,nbins=nb,locations=xrat)  &  fTm = fTm / total(fTm)
  window,2
  plot,xrat,fNe,psym=10,charsize=2,xtit='N!De2!N/N!De1!N',title='Frequency histogram'
  xyouts,[0.6,0.6],[0.8,0.75],['Mean = ','Stdev = ']+strmid(string([mean(rNe),stdev(rNe)]),6,5),charsize=2,/normal


record_gif,'./','Frequency histogram Ne','X'

  window,3
  plot,xrat,fTm,psym=10,charsize=2,xtit='T!Dm2!N/T!Dm1!N',title='Frequency histogram'
  xyouts,[0.6,0.6],[0.8,0.75],['Mean = ','Stdev = ']+strmid(string([mean(rTm),stdev(rTm)]),6,5),charsize=2,/normal

record_gif,'./','Frequency histogram Tm','X' 

mapa:

; ALBERT BORRO TODOS ESTOS:
;ldemfile='LDEM.v2_cr2081_l0.75_chianti.ioneq_sun_coronal_1992_feldman_ext.abund_euvi.A_L171_gauss1_lin_Norm-median_singlStart'
;ldemfile='LDEM.v3_cr2099_l1.0_chianti.ioneq_sun_coronal_1992_feldman_ext.abund_euvi.B_L171_NODECON_gauss1_lin_Norm-median_singlStart'
;ldemfile='LDEM.v3_CR2099_l0.75_chianti.ioneq_sun_coronal_1992_feldman_ext.abund_AIA3_FullCorona_192_corregido_gauss1_lin_Norm-median_singlStart'
;ldemfile='LDEM.v3_CR2099_l0.75_chianti.ioneq_sun_coronal_1992_feldman_ext.abund_AIA4_FullCorona_256_corregido_gauss2FW_lin_Norm-median_singlStart'
;ldemfile='LDEM.v3_CR2099_l0.75_chianti.ioneq_sun_coronal_1992_feldman_ext.abund_AIA3_FullCorona_192_corregido_gauss1_lin_Norm-meian_singlStart'
;ldemfile='LDEM.v3_CR2099_l0.75_chianti.ioneq_sun_coronal_1992_feldman_ext.abund_AIA3_FullCorona_albert_171_corregido_gauss1_lin_Norm-median_singlStart'
;ldemfile='LDEM.v3_CR2099_l0.75_chianti.ioneq_sun_coronal_1992_feldman_ext.abund_AIA4_FullCorona_albert_256_corregido_gauss2FW_lin_Norm-median_singlStart'
;ldemfile='LDEM.v2_CR2099_l0.75_chianti.ioneq_sun_coronal_1992_feldman_ext.abund_AIA4_1075Rs_256_gauss2FW_lin_Norm-median_singlStart'
;ldemfile='LDEM.v3_CR2099_l0.75_chianti.ioneq_sun_coronal_1992_feldman_ext.abund_AIA4_ALBERT-2_256_corregido_gauss2FW_lin_Norm-median_singlStart'


;LOS ARCHIVOS FINALES SON ESTOS:
;ldemfile='LDEM.v3_CR2099_l0.75_chianti.ioneq_sun_coronal_1992_feldman_ext.abund_AIA3_FULLCORONA-ALBERT_171_corregido_gauss1_lin_Norm-median_singlStart'
;ldemfile='LDEM.v3_CR2099_l0.75_chianti.ioneq_sun_coronal_1992_feldman_ext.abund_AIA4_FULLCORONA-ALBERT_256_corregido_gauss2FW_lin_Norm-median_singlStart'
;ldemfile='LDEM.v3_cr2099_l1.0_chianti.ioneq_sun_coronal_1992_feldman_ext.abund_euvi.A_L171_NODECON_gauss1_lin_Norm-median_singlStart'
 
print,ldemfile

  read_ldem_albert,ldemfile,/ldem,/gauss1
 ;read_ldem_albert,ldemfile,/ldem,/dgfw
 ...
 ;graficos,7,scalefactor,'CR2099_EUVIB-l1.0_albert',Nemax=1.5,Tmmax=2.5,Ermax=1.0,/xtit,/ytit,/Bfield  ;1.075 Rsun
 ;graficos,7,scalefactor,'CR2099_AIA3-l0.75',instrument='aia',Nemax=1.5,Tmmax=2.5,Ermax=1.0,/xtit,/ytit,/Bfield  ;1.075 Rsun
 ;graficos,7,scalefactor,'CR2099_AIA4-l0.75',instrument='aia',Nemax=1.5,Tmmax=2.5,Ermax=1.0,/xtit,/ytit,/Bfield  ;1.075 Rsun


 ;graficos,7,scalefactor,'CR2099_AIA3-l0.75-ALBERT-FULLCORONA',instrument='aia',Nemax=1.5,Tmmax=2.5,Ermax=1.0,/xtit,/ytit,/Bfield  ;1.075 Rsun
 ;graficos,7,scalefactor,'CR2099_AIA4-l0.75-ALBERT-FULLCORONA',instrument='aia',Nemax=1.5,Tmmax=2.5,Ermax=1.0,/xtit,/ytit,/Bfield  ;1.075 Rsun
  graficos,7,scalefactor,'CR2099_EUVIA-l1.0-CECI-FULLCORONA'                   ,Nemax=1.5,Tmmax=2.5,Ermax=1.0,/xtit,/ytit,/Bfield  ;1.075 Rsun
...
pro graficos,ir,scalefactor,suffix,instrument=instrument,zbuff=zbuff,Bfield=Bfield,xtit=xtit,ytit=ytit,Nemax=Nemax,Tmmax=Tmmax,Ermax=Ermax
  common comunes,tm,wt,nband,demc,PHI,parametrizacion,Tmin,Tmax,nr,nth,np,rad,lat,lon,lambda,WTc
  common results_tomo,tfbe,sfbe,N_e
  common devi,dev
...
; calculate chi^2 and R
 ...
 if not keyword_set(Ermax) then Ermax=2.0
 Nesat = N_e
 Tmsat = Tm
 Ersat = Er ;<---
 ...
 if CNS(0) ne -1 then begin
  ...
  record_gif,'~/','R_'+suffix+'.gif';,'X'

 display_carrmap,Nesat/1.e8,ir,2*Nband+1,scalefactor,1.,0.,Nemax,4,'Ne [10!U8!Ncm!U-3!N] @ '+strmid(suffix,0,5)+' Rsun',instrument
 record_gif,'~/','Ne_'+suffix+'.gif';,'X'

 display_carrmap,Tmsat/1.e6,ir,2*Nband+2,scalefactor,1.,0.,Tmmax,5,'Tm [MK] @'+strmid(suffix,0,5)+' Rsun',instrument
 record_gif,'~/','Tm_'+suffix+'.gif';,'X'

 display_carrmap,Ersat/1.e-5,ir,2*Nband+3,scalefactor,1.,0.,Ermax,5,'Er [10!U-5!Nergcm!U-3!Ns!U-1!N] @'+strmid(suffix,0,5)+' Rsun',instrument
 record_gif,'~/','Er_'+suffix+'.gif';,'X'
