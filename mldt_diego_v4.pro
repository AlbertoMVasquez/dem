pro revision_2019
  ...
  common statistic_loops2,opclstat,lambda_N,lambda_p,Ne0,p0,Tefit,gradT,r2N,r2P,r2T,indexloop,leg_status,Tm0,Tm0s,tm0_3,gradt_3,r2T_3,f_t,f_ne,f_ne_cuad,r2n_ts,ne0_ts,lambda_n_ts,iso,Tefit_ts,iso_s,gradT_3s,long_r,long_s,tm0_3s
  ...
  common stat_filter2,opclstat_c,lambda_N_c,lambda_p_c,Ne0_c,p0_c,Tefit_c,gradT_c,r2N_c,r2P_c,r2T_c,indexloop_c,leg_status_c,Tm0_c,Tm0s_c,Nebasal_c,Tbasal_c,iso_c,Tefit_ts_c,tm0_3s_c,tm0_3_c
...
;LA IDEA DE ESTE CODIGO ES TESTEAR CR2082 DEMT TRAZADO SOBRE AWSOM, YA
;QUE HUBO MEJORAS A BAJAS ALTURAS DEBIDO A R3D. Y ADEMAS COMPARARLA
;CON CR2081 TRAZADO A LO LARGO DEL CORRESPONDIENTE CAMPO AWSOM.

;  rstart1  = 1.035+0.02*findgen(10)
;  alturas1 = n_elements(rstart1)

  rstart = 1.025+0.04*findgen(6)
  alturas = n_elements(rstart)

  filesT=['traceLDEM_CR2081_reg0.75_safety0.5_fullhollow_awsomfield_decon_radstart-1.035-1.215Rs_unifgrid_v2.heating.sampled.v2.DIEGO.dat',$       ;fullhollow decon regu 
          'traceLDEM_CR2081_reg0.75_safety0.5_fulldisk_awsomfield_awsom_radstart-1.035-1.215Rs_unifgrid_v2.heating.sampled.v2.DIEGO.dat',$    ;datos awsom, field awsom
          'traceLDEM_CR2081_euviA-NODECON_reg0.75_safety0.5_errorbox_base_DEBUG_radstart-1.035-1.215Rs_unifgrid_v2.heating.sampled.v2.DIEGO.dat',$;paper
          'traceLDEM_CR2081_euviA-DECON_DEBUG_reg0.75_safety0.5_radstart-1.035-1.215Rs_unifgrid_v2.heating.sampled.v2.DIEGO_radstart-1.035-1.215Rs_unifgrid_v2.heating.sampled.v2.DIEGO.dat',$;paper
          'traceLDEM_CR2082_test_awsom_full_asd_diarrea_putrefacta_radstart-1.025-1.225Rs_unifgrid_v2.heating.sampled.v2.DIEGO.dat',$ ;nuevo con termodinamica awsom y B_awsom
          'traceLDEM_CR2082_test_DEMT_full_asd_diarrea_putrefacta2_radstart-1.025-1.225Rs_unifgrid_v2.heating.sampled.v2.DIEGO.dat'] ;nuevo con datos demt y sB_awsom

fcrit_t=0.7
fcrit_n=0.75
r2crit_t=0.7
r2crit_N=0.75
statloop,filesT[5],rloopmin=1.05,/linear,/FITCUAdr,/altura,/error_euvi
stop
Rpoint_map2,footlat,footlon,opclstat,f_t,r2N_ts,r2crit_t,r2crit_N,gradT_3                                  ,filelabel='_5colores_prueba1',/foot_punto,/euvi
Rpoint_map2,footlat,footlon,opclstat,f_t,r2N_ts,r2crit_t,r2crit_N,gradT_3,Rp_full.alto.lat,Rp_full.alto.lon,filelabel='_5colores_prueba2',/r_punto,/euvi
...
histoplot,Nebasal_c_0_B/1.e8   ,min=0.5,max=3.5,nbins=50,xtit='r2n_ts',ytit='freq',tit='H_decon_awsomfield',filename='histo_nebasal_fullhollow_decon_awsomfield'                                             
histoplot,Tmmean_c_0_B/1.e6  ,min=0.5,max=2,nbins=50,xtit='f_t'   ,ytit='freq',tit='H_decon_awsomfield',filename='histo_tmean_fullhollow_decon_awsomfield'
histoplot,lambda_N_c_0_B  ,min=0.05,max=0.2,nbins=50,xtit='f_t'   ,ytit='freq',tit='H_decon_awsomfield',filename='histo_lambda_fullhollow_decon_awsomfield'
histoplot,Br0_c_0_B  ,min=0,max=6,nbins=50,xtit='f_t'   ,ytit='freq',tit='H_decon_awsomfield',filename='histo_br0_fullhollow_decon_awsomfield'  
...
;la idea de este codigo es colage 2018

;rstart      = 1.075
rstart      = 1.035+0.02*findgen(10)
alturas = n_elements(rstart)
filesT=['traceLDEM_CR2081_reg0.75_safety0.5_fulldisk_awsomfield_mapoc1075_radstart-1.075Rs_unifgrid_v2.heating.sampled.v2.DIEGO.dat',$;testeo
        'traceLDEM_CR2081_euviA-NODECON_reg0.75_safety0.5_errorbox_base_DEBUG_radstart-1.035-1.215Rs_unifgrid_v2.heating.sampled.v2.DIEGO.dat',$
        'traceLDEM_CR2081_reg0.75_safety0.5_fullhollow_awsomfield_decon_radstart-1.035-1.215Rs_unifgrid_v2.heating.sampled.v2.DIEGO.dat',$;fullhollow decon regu
        'traceLDEM_CR2081_reg0.75_safety0.5_fulldisk_awsomfield_awsom_radstart-1.035-1.215Rs_unifgrid_v2.heating.sampled.v2.DIEGO.dat'];datos awsom, field awsom

files_ldem=['LDEM.v3_cr2081_l0.375_chianti.ioneq_sun_coronal_1992_feldman_ext.abund_euvi.A_L171_DECON_FULLHOLLOW_gauss1_lin_Norm-median_singlStart',$
            'CR2081run5_DEMT_sphere.dat']
...
;========
;Esta parte es para hacer histogramas y chequeo de demt fullhollow
;decon con la nueva regularizacion para todas las regiones de los
;papers y abajo lo mismo pero para awsom_old_setup con campo awsom.
goto,directo_a_graficos_poster
stop
statloop,filesT[2],rloopmin=1.05,/linear,/FITCUAdr,/altura,/error_euvi
;stop

;histoplot,r2n_ts(where(r2n_ts gt 0.)),min=0,max=1,nbins=50,xtit='r2n_ts',ytit='freq',tit='fullH_decon_awsomfield',filename='histo_r2n_ts_fullhollow_decon_awsomfield'
;histoplot,f_t(where(f_t gt 0.))      ,min=0,max=1,nbins=50,xtit='f_t'   ,ytit='freq',tit='fullH_decon_awsomfield',filename='histo_f_t_fullhollow_decon_awsomfield'

;Rpoint_map2,footlat,footlon,opclstat,f_t,r2N_ts,r2crit_t,r2crit_N,gradT_3,Rp_full.alto.lat,Rp_full.alto.lon,filelabel='_5colores_fullhollow_decon_awsomfield',/r_punto,/euvi
;Rpoint_map2,footlat,footlon,opclstat,f_t,r2N_ts,r2crit_t,r2crit_N,gradT_3                                  ,filelabel='_5colores_fullhollow_decon_awsomfield',/foot_punto,/euvi

;stop
;este sector es para testear que la termodinamica sea comparable con
;la del paper, entonces la LDEM este ok.
gradT = gradt_3
r2n = r2n_ts
r2T = f_t
lonmax=360
...
Tmmean_c_0_A=Tmmean_c
    Bmean_c_0_A=Bmean_c
      Br0_c_0_A=Br0_c
histoplot,Nebasal_c_0_A/1.e8 ,min=0.5,max=2.5,nbins=50,xtit='Ne_basal',ytit='freq',tit='lowlat',filename='histo_2081_fullhollow_decon_awsomfield_Nebasal_lowlat'
histoplot,Tmmean_c_0_A/1.e6  ,min=0.5,max=2.0,nbins=50,xtit='Te_mean' ,ytit='freq',tit='lowlat',filename='histo_2081_fullhollow_decon_awsomfield_Tm_lowlat'
histoplot,lambda_N_c_0_A    ,min=0.04,max=0.2,nbins=50,xtit='lambda'  ,ytit='freq',tit='lowlat',filename='histo_2081_fullhollow_decon_awsomfield_lambda_lowlat'
...
Tmmean_c_1_A=Tmmean_c
    Bmean_c_1_A=Bmean_c
      Br0_c_1_A=Br0_c
histoplot,Nebasal_c_1_A/1.e8 ,min=0.5,max=2.5,nbins=50,xtit='Ne_basal',ytit='freq',tit='midlatN',filename='histo_2081_fullhollow_decon_awsomfield_Nebasal_midlatN'
histoplot,Tmmean_c_1_A/1.e6  ,min=0.5,max=2.0,nbins=50,xtit='Te_mean' ,ytit='freq',tit='midlatN',filename='histo_2081_fullhollow_decon_awsomfield_Tm_midlatN'
histoplot,lambda_N_c_1_A    ,min=0.04,max=0.2,nbins=50,xtit='lambda'  ,ytit='freq',tit='midlatN',filename='histo_2081_fullhollow_decon_awsomfield_lambda_midlatN'
...
Tmmean_c_2_A=Tmmean_c
    Bmean_c_2_A=Bmean_c
      Br0_c_2_A=Br0_c
histoplot,Nebasal_c_2_A/1.e8 ,min=0.5,max=2.5,nbins=50,xtit='Ne_basal',ytit='freq',tit='midlatS',filename='histo_2081_fullhollow_decon_awsomfield_Nebasal_midlatS'
histoplot,Tmmean_c_2_A/1.e6  ,min=0.5,max=2.0,nbins=50,xtit='Te_mean' ,ytit='freq',tit='midlatS',filename='histo_2081_fullhollow_decon_awsomfield_Tm_midlatS'
histoplot,lambda_N_c_2_A    ,min=0.04,max=0.2,nbins=50,xtit='lambda'  ,ytit='freq',tit='midlatS',filename='histo_2081_fullhollow_decon_awsomfield_lambda_midlatS'
...
Tmmean_c_3_A=Tmmean_c
    Bmean_c_3_A=Bmean_c
      Br0_c_3_A=Br0_c
histoplot,Nebasal_c_3_A/1.e8 ,min=0.5,max=2.5,nbins=50,xtit='Ne_basal',ytit='freq',tit='OCN',filename='histo_2081_fullhollow_decon_awsomfield_Nebasal_OCN'
histoplot,Tmmean_c_3_A/1.e6  ,min=0.5,max=2.0,nbins=50,xtit='Te_mean' ,ytit='freq',tit='OCN',filename='histo_2081_fullhollow_decon_awsomfield_Tm_OCN'
histoplot,lambda_N_c_3_A    ,min=0.04,max=0.2,nbins=50,xtit='lambda'  ,ytit='freq',tit='OCN',filename='histo_2081_fullhollow_decon_awsomfield_lambda_OCN'
...
Tmmean_c_4_A=Tmmean_c
    Bmean_c_4_A=Bmean_c
      Br0_c_4_A=Br0_c
histoplot,Nebasal_c_4_A/1.e8 ,min=0.5,max=2.5,nbins=50,xtit='Ne_basal',ytit='freq',tit='OCS',filename='histo_2081_fullhollow_decon_awsomfield_Nebasal_OCS'
histoplot,Tmmean_c_4_A/1.e6  ,min=0.5,max=2.0,nbins=50,xtit='Te_mean' ,ytit='freq',tit='OCS',filename='histo_2081_fullhollow_decon_awsomfield_Tm_OCS'
histoplot,lambda_N_c_4_A    ,min=0.04,max=0.2,nbins=50,xtit='lambda'  ,ytit='freq',tit='OCS',filename='histo_2081_fullhollow_decon_awsomfield_lambda_OCS'
...
Tmmean_c_6_AL=Tmmean_c
    Bmean_c_6_AL=Bmean_c
      Br0_c_6_AL=Br0_c
histoplot,Nebasal_c_6_AL/1.e8 ,min=0.5,max=2.5,nbins=50,xtit='Ne_basal',ytit='freq',tit='CHlbs',filename='histo_2081_fullhollow_decon_awsomfield_Nebasal_CHlbs'
histoplot,Tmmean_c_6_AL/1.e6  ,min=0.5,max=2.0,nbins=50,xtit='Te_mean' ,ytit='freq',tit='CHlbs',filename='histo_2081_fullhollow_decon_awsomfield_Tm_CHlbs'
histoplot,lambda_N_c_6_AL    ,min=0.04,max=0.2,nbins=50,xtit='lambda'  ,ytit='freq',tit='CHlbs',filename='histo_2081_fullhollow_decon_awsomfield_lambda_CHlbs'
...
Tmmean_c_6_AH=Tmmean_c
    Bmean_c_6_AH=Bmean_c
      Br0_c_6_AH=Br0_c
histoplot,Nebasal_c_6_AH/1.e8 ,min=0.5,max=2.5,nbins=50,xtit='Ne_basal',ytit='freq',tit='CHlas',filename='histo_2081_fullhollow_decon_awsomfield_Nebasal_CHlas'
histoplot,Tmmean_c_6_AH/1.e6  ,min=0.5,max=2.0,nbins=50,xtit='Te_mean' ,ytit='freq',tit='CHlas',filename='histo_2081_fullhollow_decon_awsomfield_Tm_CHlas'
histoplot,lambda_N_c_6_AH    ,min=0.04,max=0.2,nbins=50,xtit='lambda'  ,ytit='freq',tit='CHlas',filename='histo_2081_fullhollow_decon_awsomfield_lambda_CHlas'
...
Tmmean_c_5_AL=Tmmean_c
    Bmean_c_5_AL=Bmean_c
      Br0_c_5_AL=Br0_c
histoplot,Nebasal_c_5_AL/1.e8 ,min=0.5,max=2.5,nbins=50,xtit='Ne_basal',ytit='freq',tit='CHlbn',filename='histo_2081_fullhollow_decon_awsomfield_Nebasal_CHlbn'
histoplot,Tmmean_c_5_AL/1.e6  ,min=0.5,max=2.0,nbins=50,xtit='Te_mean' ,ytit='freq',tit='CHlbn',filename='histo_2081_fullhollow_decon_awsomfield_Tm_CHlbn'
histoplot,lambda_N_c_5_AL    ,min=0.04,max=0.2,nbins=50,xtit='lambda'  ,ytit='freq',tit='CHlbn',filename='histo_2081_fullhollow_decon_awsomfield_lambda_CHlbn'
...
Tmmean_c_5_AH=Tmmean_c
    Bmean_c_5_AH=Bmean_c
      Br0_c_5_AH=Br0_c
histoplot,Nebasal_c_5_AH/1.e8 ,min=0.5,max=2.5,nbins=50,xtit='Ne_basal',ytit='freq',tit='CHlan',filename='histo_2081_fullhollow_decon_awsomfield_Nebasal_CHlan'
histoplot,Tmmean_c_5_AH/1.e6  ,min=0.5,max=2.0,nbins=50,xtit='Te_mean' ,ytit='freq',tit='CHlan',filename='histo_2081_fullhollow_decon_awsomfield_Tm_CHlan'
histoplot,lambda_N_c_5_AH    ,min=0.04,max=0.2,nbins=50,xtit='lambda'  ,ytit='freq',tit='CHlan',filename='histo_2081_fullhollow_decon_awsomfield_lambda_CHlan'

stop

statloop,filesT[3],rloopmin=1.05,/linear,/FITCUAdr,/altura,/error_euvi,/awsom

;histoplot,r2n_ts(where(r2n_ts gt 0.)),min=0,max=1,nbins=50,xtit='r2n_ts',ytit='freq',tit='awsom_awsomfield',filename='histo_r2n_ts_awsom_awsomfield_nuevoajuste'
;histoplot,f_t(where(f_t gt 0.))      ,min=0,max=1,nbins=50,xtit='f_t'   ,ytit='freq',tit='awsom_awsomfield',filename='histo_f_t_awsom_awsomfield_nuevoajuste'

;Rpoint_map2,footlat,footlon,opclstat,f_t,r2N_ts,r2crit_t,r2crit_N,gradT_3,Rp_full.alto.lat,Rp_full.alto.lon,filelabel='_5colores_awsom_awsomfield',/r_punto,/euvi
;Rpoint_map2,footlat,footlon,opclstat,f_t,r2N_ts,r2crit_t,r2crit_N,gradT_3                                  ,filelabel='_5colores_awsom_awsomfield',/foot_punto,/euvi
...
Tmmean_c_0_A=Tmmean_c
    Bmean_c_0_A=Bmean_c
      Br0_c_0_A=Br0_c
histoplot,Nebasal_c_0_A/1.e8 ,min=0.5,max=2.5,nbins=50,xtit='Ne_basal',ytit='freq',tit='lowlat',filename='histo_2081_awsom_awsomfield_Nebasal_lowlat'
histoplot,Tmmean_c_0_A/1.e6  ,min=0.5,max=2.0,nbins=50,xtit='Te_mean' ,ytit='freq',tit='lowlat',filename='histo_2081_awsom_awsomfield_Tm_lowlat'
histoplot,lambda_N_c_0_A    ,min=0.04,max=0.2,nbins=50,xtit='lambda'  ,ytit='freq',tit='lowlat',filename='histo_2081_awsom_awsomfield_lambda_lowlat'
...
Tmmean_c_1_A=Tmmean_c
    Bmean_c_1_A=Bmean_c
      Br0_c_1_A=Br0_c
histoplot,Nebasal_c_1_A/1.e8 ,min=0.5,max=2.5,nbins=50,xtit='Ne_basal',ytit='freq',tit='midlatN',filename='histo_2081_awsom_awsomfield_Nebasal_midlatN'
histoplot,Tmmean_c_1_A/1.e6  ,min=0.5,max=2.0,nbins=50,xtit='Te_mean' ,ytit='freq',tit='midlatN',filename='histo_2081_awsom_awsomfield_Tm_midlatN'
histoplot,lambda_N_c_1_A    ,min=0.04,max=0.2,nbins=50,xtit='lambda'  ,ytit='freq',tit='midlatN',filename='histo_2081_awsom_awsomfield_lambda_midlatN'
...
Tmmean_c_2_A=Tmmean_c
    Bmean_c_2_A=Bmean_c
      Br0_c_2_A=Br0_c
histoplot,Nebasal_c_2_A/1.e8 ,min=0.5,max=2.5,nbins=50,xtit='Ne_basal',ytit='freq',tit='midlatS',filename='histo_2081_awsom_awsomfield_Nebasal_midlatS'
histoplot,Tmmean_c_2_A/1.e6  ,min=0.5,max=2.0,nbins=50,xtit='Te_mean' ,ytit='freq',tit='midlatS',filename='histo_2081_awsom_awsomfield_Tm_midlatS'
histoplot,lambda_N_c_2_A    ,min=0.04,max=0.2,nbins=50,xtit='lambda'  ,ytit='freq',tit='midlatS',filename='histo_2081_awsom_awsomfield_lambda_midlatS'
...
Tmmean_c_3_A=Tmmean_c
    Bmean_c_3_A=Bmean_c
      Br0_c_3_A=Br0_c
histoplot,Nebasal_c_3_A/1.e8 ,min=0.5,max=2.5,nbins=50,xtit='Ne_basal',ytit='freq',tit='OCN',filename='histo_2081_awsom_awsomfield_Nebasal_OCN'
histoplot,Tmmean_c_3_A/1.e6  ,min=0.5,max=2.0,nbins=50,xtit='Te_mean' ,ytit='freq',tit='OCN',filename='histo_2081_awsom_awsomfield_Tm_OCN'
histoplot,lambda_N_c_3_A    ,min=0.04,max=0.2,nbins=50,xtit='lambda'  ,ytit='freq',tit='OCN',filename='histo_2081_awsom_awsomfield_lambda_OCN'
...
Tmmean_c_4_A=Tmmean_c
    Bmean_c_4_A=Bmean_c
      Br0_c_4_A=Br0_c
histoplot,Nebasal_c_4_A/1.e8 ,min=0.5,max=2.5,nbins=50,xtit='Ne_basal',ytit='freq',tit='OCS',filename='histo_2081_awsom_awsomfield_Nebasal_OCS'
histoplot,Tmmean_c_4_A/1.e6  ,min=0.5,max=2.0,nbins=50,xtit='Te_mean' ,ytit='freq',tit='OCS',filename='histo_2081_awsom_awsomfield_Tm_OCS'
histoplot,lambda_N_c_4_A    ,min=0.04,max=0.2,nbins=50,xtit='lambda'  ,ytit='freq',tit='OCS',filename='histo_2081_awsom_awsomfield_lambda_OCS'
...
Tmmean_c_6_AL=Tmmean_c
    Bmean_c_6_AL=Bmean_c
      Br0_c_6_AL=Br0_c
histoplot,Nebasal_c_6_AL/1.e8 ,min=0.5,max=2.5,nbins=50,xtit='Ne_basal',ytit='freq',tit='CHlbs',filename='histo_2081_awsom_awsomfield_Nebasal_CHlbs'
histoplot,Tmmean_c_6_AL/1.e6  ,min=0.5,max=2.0,nbins=50,xtit='Te_mean' ,ytit='freq',tit='CHlbs',filename='histo_2081_awsom_awsomfield_Tm_CHlbs'
histoplot,lambda_N_c_6_AL    ,min=0.04,max=0.2,nbins=50,xtit='lambda'  ,ytit='freq',tit='CHlbs',filename='histo_2081_awsom_awsomfield_lambda_CHlbs'
...
Tmmean_c_6_AH=Tmmean_c
    Bmean_c_6_AH=Bmean_c
      Br0_c_6_AH=Br0_c
histoplot,Nebasal_c_6_AH/1.e8 ,min=0.5,max=2.5,nbins=50,xtit='Ne_basal',ytit='freq',tit='CHlas',filename='histo_2081_awsom_awsomfield_Nebasal_CHlas'
histoplot,Tmmean_c_6_AH/1.e6  ,min=0.5,max=2.0,nbins=50,xtit='Te_mean' ,ytit='freq',tit='CHlas',filename='histo_2081_awsom_awsomfield_Tm_CHlas'
histoplot,lambda_N_c_6_AH    ,min=0.04,max=0.2,nbins=50,xtit='lambda'  ,ytit='freq',tit='CHlas',filename='histo_2081_awsom_awsomfield_lambda_CHlas'
...
Tmmean_c_5_AL=Tmmean_c
    Bmean_c_5_AL=Bmean_c
      Br0_c_5_AL=Br0_c
histoplot,Nebasal_c_5_AL/1.e8 ,min=0.5,max=2.5,nbins=50,xtit='Ne_basal',ytit='freq',tit='CHlbn',filename='histo_2081_awsom_awsomfield_Nebasal_CHlbn'
histoplot,Tmmean_c_5_AL/1.e6  ,min=0.5,max=2.0,nbins=50,xtit='Te_mean' ,ytit='freq',tit='CHlbn',filename='histo_2081_awsom_awsomfield_Tm_CHlbn'
histoplot,lambda_N_c_5_AL    ,min=0.04,max=0.2,nbins=50,xtit='lambda'  ,ytit='freq',tit='CHlbn',filename='histo_2081_awsom_awsomfield_lambda_CHlbn'
...
Tmmean_c_5_AH=Tmmean_c
    Bmean_c_5_AH=Bmean_c
      Br0_c_5_AH=Br0_c
histoplot,Nebasal_c_5_AH/1.e8 ,min=0.5,max=2.5,nbins=50,xtit='Ne_basal',ytit='freq',tit='CHlan',filename='histo_2081_awsom_awsomfield_Nebasal_CHlan'
histoplot,Tmmean_c_5_AH/1.e6  ,min=0.5,max=2.0,nbins=50,xtit='Te_mean' ,ytit='freq',tit='CHlan',filename='histo_2081_awsom_awsomfield_Tm_CHlan'
histoplot,lambda_N_c_5_AH    ,min=0.04,max=0.2,nbins=50,xtit='lambda'  ,ytit='freq',tit='CHlan',filename='histo_2081_awsom_awsomfield_lambda_CHlan'
stop

;=========
;aca comienza los graficos para poster Colage 2018

directo_a_graficos_poster:

rad=1.025 + 0.005 *findgen(46)
...
filter,i_lowlat
lambda_lowlat_0=lambda_N_ts_c
Nebasal_lowlat_0=Nebasal_ts_c
lambda_lowlat_0=lambda_N_c
Nebasal_lowlat_0=Nebasal_c

Tmmean_lowlat_0 =Tmmean_c
Ne0_lowlat_0=Ne0_c
Tm0_lowlat_0=Tm0_3_c
gradt_0_lowlat = gradt_3 (i_lowlat)

Ne_lowlat_demt = median(Ne0_lowlat_0) * exp(-1/(median(lambda_lowlat_0)) * (1 - 1/rad) )
;Te_lowlat_demt = median(Tm0_lowlat_0(where (gradt_0_lowlat le 0.))) + median(gradT_0_lowlat(where (gradt_0_lowlat le 0.))) * rad
Te_lowlat_demt = median(Tm0_lowlat_0) + median(gradT_0_lowlat) * rad
sup_ne_lowlat_demt = median(Ne0_lowlat_0/1.e8 + err_ne_lowlat) * exp(-1/(median(lambda_lowlat_0 - err_la_lowlat)) * (1 - 1/rad))
min_ne_lowlat_demt = median(Ne0_lowlat_0/1.e8 - err_ne_lowlat) * exp(-1/(median(lambda_lowlat_0 + err_la_lowlat)) * (1 - 1/rad))
sup_te_lowlat_demt = Te_lowlat_demt/1.e6 + err_te_lowlat
min_te_lowlat_demt = Te_lowlat_demt/1.e6 - err_te_lowlat


St_LIN=30
St_LIS=-27
i_midlat_small_norte_y_sur = where(gradT ne -555. AND opclstat eq 2. and r2N gt r2crit_N and (footlat gt St_LIN or footlat lt St_LIS) and footlon le lonmax and r2T gt r2crit_T )
filter, i_midlat_small_norte_y_sur
lambda_midlat_0=lambda_N_ts_c
Nebasal_midlat_0=Nebasal_ts_c
Tmmean_midlat_0=Tmmean_c
Ne0_midlat_0=Ne0_c
Tm0_midlat_0=Tm0_3_c
gradt_0_midlat = gradt_3 (i_midlat_small_norte_y_sur)

Ne_midlat_demt = median(Ne0_midlat_0) * exp(-1/(median(lambda_midlat_0)) * (1 - 1/rad))
Te_midlat_demt = median(Tm0_midlat_0(where (gradt_0_midlat ge 0.))) + median(gradT_0_midlat(where (gradt_0_midlat ge 0.))) * rad
sup_ne_midlat_demt = median(Ne0_midlat_0/1.e8 + err_ne_midlat) * exp(-1/(median(lambda_midlat_0 - err_la_midlat)) * (1 - 1/rad))
min_ne_midlat_demt = median(Ne0_midlat_0/1.e8 - err_ne_midlat) * exp(-1/(median(lambda_midlat_0 + err_la_midlat)) * (1 - 1/rad))
sup_te_midlat_demt = Te_midlat_demt/1.e6 + err_te_midlat
min_te_midlat_demt = Te_midlat_demt/1.e6 - err_te_midlat

CH_LBN=65
CH_LAN=76
CH_LBS=-65
CH_LAS=-76
i_open_chs = where(gradT ne -555. AND opclstat eq 0. and r2N ge r2crit_N and ((footlat lt CH_LAN and footlat gt CH_LBN) or (footlat gt CH_LAS and footlat lt CH_LBS )) and footlon le lonmax and r2T gt r2crit_T )
filter, i_open_chs
lambda_chs_0=lambda_N_ts_c
Nebasal_chs_0=Nebasal_ts_c
lambda_chs_0=lambda_N_c
Nebasal_chs_0=Nebasal_c
Tmmean_chs_0=Tmmean_c
Ne0_chs_0=Ne0_c
Tm0_chs_0=Tm0_3_c
gradt_0_chs = gradt_3 (i_open_chs)
;gradt_3s_chs = gradt_3s (i_open_chs)

Ne_chs_demt = median(Ne0_chs_0) * exp(-1/(median(lambda_chs_0)) * (1 - 1/rad))
Te_chs_demt = median(Tm0_chs_0) + median(gradT_0_chs) * rad
sup_ne_chs_demt = median(Ne0_chs_0/1.e8 + err_ne_chs) * exp(-1/(median(lambda_chs_0 - err_la_chs)) * (1 - 1/rad))
min_ne_chs_demt = median(Ne0_chs_0/1.e8 - err_ne_chs) * exp(-1/(median(lambda_chs_0 + err_la_chs)) * (1 - 1/rad))
sup_te_chs_demt = Te_chs_demt/1.e6 + err_te_chs
min_te_chs_demt = Te_chs_demt/1.e6 - err_te_chs

;stop


;histoplot,Tm0_chs_0(where (gradt_0_chs ge 0.))/1.e6,min=-5,max=3,nbins=50,xtit='asd',ytit='asd',tit='asd',filename='probando_mierda',ndig=5
;histoplot,gradT_0_chs(where (gradt_0_chs ge 0.))/1.e6,min=0,max=6,nbins=50,xtit='asd',ytit='asd',tit='asd',filename='probando_mierda2',ndig=5

;histoplot,Tm0_3_c/1.e6,min=-5,max=3,nbins=50,xtit='asd',ytit='asd',tit='asd',filename='probando_mierda',ndig=5
;histoplot,gradT_3s_chs(where (gradt_3s_chs ge 0.))/1.e6,min=0,max=6,nbins=50,xtit='asd',ytit='asd',tit='asd',filename='probando_mierda2',ndig=5
;te_nuevo_chs = median(Tm0_3_c) + median(gradT_0_chs) * rad

;rotacion=''
;Rpoint_map,Rp_lat_c,Rp_lon_c,opclstat_c,filelabel='probando_mierda3',indexloop_c,rotacion

statloop,filesT[3],rloopmin=1.05,/linear,/FITCUAdr,/altura,/error_euvi,/awsom

rad3=1.025 + 0.005 *findgen(6)
rad2=1.055 + 0.005 *findgen(40)
gradT = gradt_3
gradt_3_1 = gradt_3
r2n = r2n_ts
r2T = f_t
...
i_lowlat = where(gradT ne -555. AND opclstat eq 2. and r2N gt r2crit_N and footlat le lowlatR and footlat ge lowlatL  and footlon le lonmax and r2T gt r2crit_T )
filter,i_lowlat
lambda_lowlat_1=lambda_N_ts_c
Nebasal_lowlat_1=Nebasal_ts_c
lambda_lowlat_1=lambda_N_c
Nebasal_lowlat_1=Nebasal_c
Tmmean_lowlat_1=Tmmean_c
gradt_1_lowlat = gradt_3 (i_lowlat)
Ne0_lowlat_1=Ne0_c
Tm0_lowlat_1=Tm0_3_c
Ne_lowlat_awsom2 = median(Ne0_lowlat_1) * exp(-1/(median(lambda_lowlat_1)) * (1 - 1/rad2))
Te_lowlat_awsom2 = median(Tm0_lowlat_1) + median(gradT_3_1(i_lowlat)) * rad2
...
i_midlat_small_norte_y_sur = where(gradT ne -555. AND opclstat eq 2. and r2N gt r2crit_N and (footlat gt St_LIN or footlat lt St_LIS) and footlon le lonmax and r2T gt r2crit_T )
filter, i_midlat_small_norte_y_sur
lambda_midlat_1=lambda_N_ts_c
Nebasal_midlat_1=Nebasal_ts_c
Tmmean_midlat_1=Tmmean_c
gradt_1_midlat = gradt_3 (i_midlat_small_norte_y_sur)
Ne0_midlat_1=Ne0_c
Tm0_midlat_1=Tm0_3_c
Ne_midlat_awsom2 = median(Ne0_midlat_1) * exp(-1/(median(lambda_midlat_1)) * (1 - 1/rad2))
Te_midlat_awsom2 = median(Tm0_midlat_1) + median(gradT_3_1(i_midlat_small_norte_y_sur)) * rad2
...
i_open_chs = where(gradT ne -555. AND opclstat eq 0. and r2N ge r2crit_N and ((footlat lt CH_LAN and footlat gt CH_LBN) or (footlat gt CH_LAS and footlat lt CH_LBS )) and footlon le lonmax and r2T gt r2crit_T )
filter, i_open_chs
lambda_chs_1=lambda_N_ts_c
Nebasal_chs_1=Nebasal_ts_c
lambda_chs_1=lambda_N_c
Nebasal_chs_1=Nebasal_c

Tmmean_chs_1=Tmmean_c
Ne0_chs_1=Ne0_c
Tm0_chs_1=Tm0_3_c
Ne_chs_awsom2 = median(Ne0_chs_1) * exp(-1/(median(lambda_chs_1)) * (1 - 1/rad2))
Te_chs_awsom2 = median(Tm0_chs_1) + median(gradT_3_1(i_open_chs)) * rad2
gradt_1_chs = gradt_3 (i_open_chs)


statloop,filesT[3],rloopmin=1.05,/linear,/FITCUAdr,/altura,/error_euvi,/awsom,/ajuste_awsom_bajo
gradT = gradt_3
gradt_3_2 = gradt_3
r2n = r2n_ts
r2T = f_t
...
i_lowlat = where(gradT ne -555. AND opclstat eq 2. and r2N gt r2crit_N and footlat le lowlatR and footlat ge lowlatL  and footlon le lonmax and r2T gt r2crit_T )
filter,i_lowlat
lambda_lowlat_2=lambda_N_ts_c
Nebasal_lowlat_2=Nebasal_ts_c
lambda_lowlat_2=lambda_N_c
Nebasal_lowlat_2=Nebasal_c
Tmmean_lowlat_2=Tmmean_c
Ne0_lowlat_2=Ne0_c
Tm0_lowlat_2=Tm0_3_c
Ne_lowlat_awsom = median(Ne0_lowlat_2) * exp(-1/(median(lambda_lowlat_2)) * (1 - 1/rad3))
Te_lowlat_awsom = median(Tm0_lowlat_2) + median(gradT_3_2(i_lowlat)) * rad3

St_LIN=30
St_LIS=-27
i_midlat_small_norte_y_sur = where(gradT ne -555. AND opclstat eq 2. and r2N gt r2crit_N and (footlat gt St_LIN or footlat lt St_LIS) and footlon le lonmax and r2T gt r2crit_T )
filter, i_midlat_small_norte_y_sur
lambda_midlat_2=lambda_N_ts_c
Nebasal_midlat_2=Nebasal_ts_c
Tmmean_midlat_2=Tmmean_c
Ne0_midlat_2=Ne0_c
Tm0_midlat_2=Tm0_3_c
Ne_midlat_awsom = median(Ne0_midlat_2) * exp(-1/(median(lambda_midlat_2)) * (1 - 1/rad3))
Te_midlat_awsom = median(Tm0_midlat_2) + median(gradT_3_2(i_midlat_small_norte_y_sur)) * rad3
...
i_open_chs = where(gradT ne -555. AND opclstat eq 0. and r2N ge r2crit_N and ((footlat lt CH_LAN and footlat gt CH_LBN) or (footlat gt CH_LAS and footlat lt CH_LBS )) and footlon le lonmax and r2T gt r2crit_T )
filter, i_open_chs
lambda_chs_2=lambda_N_ts_c
Nebasal_chs_2=Nebasal_ts_c
lambda_chs_2=lambda_N_c
Nebasal_chs_2=Nebasal_c

Tmmean_chs_2=Tmmean_c
Ne0_chs_2=Ne0_c
Tm0_chs_2=Tm0_3_c
Ne_chs_awsom = median(Ne0_chs_2) * exp(-1/(median(lambda_chs_2)) * (1 - 1/rad3))
Te_chs_awsom = median(Tm0_chs_2) + median(gradT_3_2(i_open_chs)) * rad3

stop
;===== nuevos histos
tit='Streamer'
nbins=50
ytit="Frequency Histogram"
histoplot2_full,  Tmmean_lowlat_1/1.e6,  Tmmean_lowlat_0/1.e6,min=0.8,max=1.6,nbins=nbins,xtit='<T!De!N> [MK]',ytit=ytit,tit=tit,filename='tm_lowlat_colage',ndig=5
histoplot2_full,  nebasal_lowlat_1/1.e8,  nebasal_lowlat_0/1.e8,min=0.5,max=2.5,nbins=nbins,xtit='N!De basal!N  [10!U8!Ncm!U-3!N]',ytit=ytit,tit=tit,filename='ne_lowlat_colage',ndig=5
histoplot2_full,  lambda_lowlat_1,  lambda_lowlat_0,min=0.03,max=0.1,nbins=nbins,xtit='Scale Height',ytit=ytit,tit=tit,filename='lambda_lowlat_colage',ndig=5

tit='Mid Latitudes'
histoplot2_full,  Tmmean_midlat_1/1.e6,  Tmmean_midlat_0/1.e6,min=0.9,max=1.7,nbins=nbins,xtit='<T!De!N> [MK]',ytit=ytit,tit=tit,filename='tm_midlat_colage',ndig=5
histoplot2_full,  nebasal_midlat_1/1.e8,  nebasal_midlat_0/1.e8,min=0.4,max=2.2,nbins=nbins,xtit='N!De basal!N [10!U8!Ncm!U-3!N]',ytit=ytit,tit=tit,filename='ne_midlat_colage',ndig=5
histoplot2_full,  lambda_midlat_1,  lambda_midlat_0,min=0.03,max=0.1,nbins=nbins,xtit='Scale Height',ytit=ytit,tit=tit,filename='lambda_midlat_colage',ndig=5

tit='Coronal Holes'
histoplot2_full,  Tmmean_chs_1/1.e6,  Tmmean_chs_0/1.e6,min=0.8,max=1.6,nbins=nbins,xtit='<T!De!N> [MK]',ytit=ytit,tit=tit,filename='tm_chs_colage',ndig=5
histoplot2_full,  nebasal_chs_1/1.e8,  nebasal_chs_0/1.e8,min=0.3,max=1.4,nbins=nbins,xtit='N!De basal!N [10!U8!Ncm!U-3!N]',ytit=ytit,tit=tit,filename='ne_chs_colage',ndig=5
histoplot2_full,  lambda_chs_1,  lambda_chs_0,min=0.03,max=0.1,nbins=nbins,xtit='Scale Height',ytit=ytit,tit=tit,filename='lambda_chs_colage',ndig=5
...
filename1='colage_testeo'
ps1,'./newfigs/ajuste_promedio_ne_lowlat_'+filename1+'.eps',0
!P.CHARTHICK=6
!p.charsize=2
loadct,12
DEVICE,/INCHES,YSIZE=5,XSIZE=10,SCALE_FACTOR=1, FONT_INDEX=4
plot, rad,Ne_lowlat_demt/1.e8,ytit='Ne [10!U8!Ncm!U-3!N]',xtit='R!DSUN!N',title='Streamer Density',yrange=[0,max(Ne_lowlat_awsom)/1.e8],/nodata,thick=5,psym=1,charthick=2.25,Font=0,charsize=2.5
xyouts,0.8*[1,1],[0.8,0.73],['DEMT','AWSoM'],/normal,color=[blue,red],charthick=5,charsize=2.3,Font=0
t1 = 1.185
t2 = 1.20
oplot,[t1,t2],max(Ne_lowlat_awsom)/1.e8*1.02 *([1,1]),linestyle=0,th=5,color=blue
oplot,[t1,t2],max(Ne_lowlat_awsom)/1.e8*0.9  *([1,1]),linestyle=0,th=5,color=red
oplot, rad,Ne_lowlat_demt/1.e8,color=blue,th=5
oplot,rad,sup_ne_lowlat_demt,color=blue,linestyle=2,th=5
oplot,rad,min_ne_lowlat_demt,color=blue,linestyle=2,th=5
oplot, rad3,Ne_lowlat_awsom/1.e8,color=red,th=5
oplot, rad2,Ne_lowlat_awsom2/1.e8,color=red,th=5
ps2

ps1,'./newfigs/ajuste_promedio_ne_midlat_'+filename1+'.eps',0
!P.CHARTHICK=6
!p.charsize=2
loadct,12
DEVICE,/INCHES,YSIZE=5,XSIZE=10,SCALE_FACTOR=1, FONT_INDEX=4
plot, rad,Ne_midlat_demt/1.e8,ytit='Ne [10!U8!Ncm!U-3!N]',xtit='R!DSUN!N',title='Mid Latitude Density',yrange=[0,max(Ne_midlat_awsom)/1.e8],/nodata,thick=5,psym=1,charthick=2.25,Font=0,charsize=2.5
xyouts,0.8*[1,1],[0.8,0.75],['DEMT','AWSoM'],/normal,color=[blue,red],charthick=5,charsize=2.3,Font=0
t1 = 1.185
t2 = 1.20
oplot,[t1,t2],max(Ne_midlat_awsom)/1.e8*1.03 *([1,1]),linestyle=0,th=5,color=blue
oplot,[t1,t2],max(Ne_midlat_awsom)/1.e8*0.95  *([1,1]),linestyle=0,th=5,color=red
oplot, rad,Ne_midlat_demt/1.e8,color=blue,th=5
oplot,rad,sup_ne_midlat_demt,color=blue,linestyle=2,th=5
oplot,rad,min_ne_midlat_demt,color=blue,linestyle=2,th=5
oplot, rad3,Ne_midlat_awsom/1.e8,color=red,th=5
oplot, rad2,Ne_midlat_awsom2/1.e8,color=red,th=5
ps2

ps1,'./newfigs/ajuste_promedio_ne_chs_'+filename1+'.eps',0
!P.CHARTHICK=6
!p.charsize=2
loadct,12
DEVICE,/INCHES,YSIZE=5,XSIZE=10,SCALE_FACTOR=1, FONT_INDEX=4
plot, rad,Ne_chs_demt/1.e8,ytit='Ne [10!U8!Ncm!U-3!N]',xtit='R!DSUN!N',title='Coronal Holes Density',yrange=[0,max(Ne_chs_awsom)/1.e8],/nodata,thick=5,psym=1,charthick=2.25,Font=0,charsize=2.5
xyouts,0.8*[1,1],[0.79,0.73],['DEMT','AWSoM'],/normal,color=[blue,red],charthick=5,charsize=2.3,Font=0
t1 = 1.185
t2 = 1.20
oplot,[t1,t2],max(Ne_chs_awsom)/1.e8*0.92 *([1,1]),linestyle=0,th=5,color=blue
oplot,[t1,t2],max(Ne_chs_awsom)/1.e8*0.83  *([1,1]),linestyle=0,th=5,color=red
oplot, rad,Ne_chs_demt/1.e8,color=blue,th=5
oplot,rad,sup_ne_chs_demt,color=blue,linestyle=2,th=5
oplot,rad,min_ne_chs_demt,color=blue,linestyle=2,th=5
oplot, rad3,Ne_chs_awsom/1.e8,color=red,th=5
oplot, rad2,Ne_chs_awsom2/1.e8,color=red,th=5
ps2

filename1='colage_testeo_3'

ps1,'./newfigs/ajuste_promedio_te_lowlat_'+filename1+'.eps',0
!P.CHARTHICK=6
!p.charsize=2
loadct,12
DEVICE,/INCHES,YSIZE=5,XSIZE=10,SCALE_FACTOR=1, FONT_INDEX=4
plot, rad,Te_lowlat_demt/1.e6,ytit='Te [MK]',xtit='R!DSUN!N',title='Streamer Temperature',/nodata,thick=5,psym=1,charthick=2.25,Font=0,charsize=2.5
xyouts,0.8*[1,1],[0.56,0.5],['DEMT','AWSoM'],/normal,color=[blue,red],charthick=5,charsize=2.3,Font=0
t1 = 1.185
t2 = 1.20
oplot,[t1,t2],max(Te_lowlat_awsom)/1.e6*0.91 *([1,1]),linestyle=0,th=5,color=blue
oplot,[t1,t2],max(Te_lowlat_awsom)/1.e6*0.77  *([1,1]),linestyle=0,th=5,color=red
oplot, rad,Te_lowlat_demt/1.e6,color=blue,th=5
oplot,rad,sup_te_lowlat_demt,color=blue,linestyle=2,th=5
oplot,rad,min_te_lowlat_demt,color=blue,linestyle=2,th=5
oplot, rad3,Te_lowlat_awsom/1.e6,color=red,th=5
oplot, rad2,Te_lowlat_awsom2/1.e6,color=red,th=5
ps2

ps1,'./newfigs/ajuste_promedio_te_midlat_'+filename1+'.eps',0
!P.CHARTHICK=6
!p.charsize=2
loadct,12
DEVICE,/INCHES,YSIZE=5,XSIZE=10,SCALE_FACTOR=1, FONT_INDEX=4
plot, rad,Te_midlat_demt/1.e6,ytit='Te [MK]',xtit='R!DSUN!N',title='Mid Latitude Temperature',/nodata,thick=5,psym=1,charthick=2.25,Font=0,charsize=2.5
xyouts,0.8*[1,1],[0.49,0.43],['DEMT','AWSoM'],/normal,color=[blue,red],charthick=5,charsize=2.3,Font=0
t1 = 1.185
t2 = 1.20
oplot,[t1,t2],max(Te_midlat_awsom)/1.e6*0.91 *([1,1]),linestyle=0,th=5,color=blue
oplot,[t1,t2],max(Te_midlat_awsom)/1.e6*0.74  *([1,1]),linestyle=0,th=5,color=red
oplot, rad,Te_midlat_demt/1.e6,color=blue,th=5
oplot,rad,sup_te_midlat_demt,color=blue,linestyle=2,th=5
oplot,rad,min_te_midlat_demt,color=blue,linestyle=2,th=5
oplot, rad3,Te_midlat_awsom/1.e6,color=red,th=5
oplot, rad2,Te_midlat_awsom2/1.e6,color=red,th=5
ps2

ps1,'./newfigs/ajuste_promedio_te_chs_'+filename1+'.eps',0
!P.CHARTHICK=6
!p.charsize=2
loadct,12
DEVICE,/INCHES,YSIZE=5,XSIZE=10,SCALE_FACTOR=1, FONT_INDEX=4
plot, rad,Te_chs_demt/1.e6,ytit='Te [MK]',xtit='R!DSUN!N',title='Coronal Holes Temperature',/nodata,thick=5,psym=1,charthick=2.25,Font=0,charsize=2.5
xyouts,0.8*[1,1],[0.68,0.62],['DEMT','AWSoM'],/normal,color=[blue,red],charthick=5,charsize=2.3,Font=0
t1 = 1.185
t2 = 1.20
oplot,[t1,t2],max(Te_chs_awsom)/1.e6*2.7  *([1,1]),linestyle=0,th=5,color=blue
oplot,[t1,t2],max(Te_chs_awsom)/1.e6*2.4  *([1,1]),linestyle=0,th=5,color=red
oplot, rad,Te_chs_demt/1.e6,color=blue,th=5
oplot,rad,sup_te_chs_demt,color=blue,linestyle=2,th=5
oplot,rad,min_te_chs_demt,color=blue,linestyle=2,th=5
oplot, rad3,Te_chs_awsom/1.e6,color=red,th=5
oplot, rad2,Te_chs_awsom2/1.e6,color=red,th=5
ps2
...
;=========
;seguimos con colage
;histogramas de D_rel=(X_SWMF - X_DEMT)/X_DEMT

d_rel_ne_demt_awsom2081_lowlat = -1 * ( Nebasal_lowlat_0 - Nebasal_lowlat_1 ) / Nebasal_lowlat_0
d_rel_ne_demt_awsom2081_midlat = -1 * ( Nebasal_midlat_0 - Nebasal_midlat_1 ) / Nebasal_midlat_0
d_rel_ne_demt_awsom2081_CH     = -1 * ( Nebasal_chs_0    - Nebasal_chs_1    ) / Nebasal_chs_0

d_rel_te_demt_awsom2081_lowlat = -1 * ( tmmean_lowlat_0 - tmmean_lowlat_1 ) / tmmean_lowlat_0
d_rel_te_demt_awsom2081_midlat = -1 * ( tmmean_midlat_0 - tmmean_midlat_1 ) / tmmean_midlat_0
d_rel_te_demt_awsom2081_CH     = -1 * ( tmmean_chs_0    - tmmean_chs_1    ) / tmmean_chs_0

histoplot,d_rel_ne_demt_awsom2081_lowlat,min= -0.9,max=0,nbins=50,xtit='',ytit='Frequency Histogram',tit='Streamer Density',filename='histo_d_rel_ne_lowlat_colage'
histoplot,d_rel_ne_demt_awsom2081_midlat,min= -0.8,max=0,nbins=50,xtit='',ytit='Frequency Histogram',tit='Mid Latitude Density',filename='histo_d_rel_ne_midlat_colage'
histoplot,d_rel_ne_demt_awsom2081_CH    ,min=-0.7,max=0.2,nbins=50,xtit='',ytit='Frequency Histogram',tit='Coronal Holes Density',filename='histo_d_rel_ne_chs_colage'

histoplot,d_rel_te_demt_awsom2081_lowlat,min=-0.5,max=0.5 ,nbins=50,xtit='',ytit='Frequency Histogram',tit='Streamer Temperature',filename='histo_d_rel_te_lowlat_colage'
histoplot,d_rel_te_demt_awsom2081_midlat,min=-0.55 ,max=0.4,nbins=50,xtit='',ytit='Frequency Histogram',tit='Mid Latitude Temperature',filename='histo_d_rel_te_midlat_colage'
histoplot,d_rel_te_demt_awsom2081_CH    ,min=-0.5  ,max=0.8,nbins=50,xtit='',ytit='Frequency Histogram',tit='Coronal Holes Temperature',filename='histo_d_rel_te_chs_colage'
...
Deltagp8B = ( a8 / mean(w2_Tmeanvec8) ) > (-vcrit) < vcrit
 ...
 nbins=50
nombre='EHI_comparacion_hi tos_new_eit_erroreuvi'
tit='St-LB'
...
; Read the FDIPS model and create a structure to serve as input to Marc's routines:
  if not keyword_set(mhd) and not keyword_setfield_(awsom)   then create_structure    ,    PFSSM_model
  if     keyword_set(mhd)                              then create_structure_MHD,    '/data1/DATA/MHD_SWMF/'+fdips_file
  if     keyword_set(field_awsom)                            then create_structure_MHD_new,'/data/DATA/MHD_SWMF/'+fdips_file
...
;-
  ...
  WTc=0.
  ;dir='/data1/DATA/MLDT/'
  dir='/data1/work/dem/github_dem/dem/'
  openr,1,dir+file
...
pro statloop,file,rmin=rmin,rmax=rmax,rloopmin=rloopmin,linear=linear,fitcuadr=fitcuadr,altura=altura,error_euvi=error_euvi,error_eit=error_eit,awsom=awsom,ajuste_awsom_bajo=ajuste_awsom_bajo
...
;      Tmmean(ileg) =   mean(Tm_l) ;----> modificado por diego 05/04/2018
    ...
    Bmean(ileg) =   mean(B_l)
;====== agregado para el ajuste de awsom que no considera radios bajos =======
    if keyword_set(awsom) then begin
       Tmmean(ileg) =  mean(Tm_l(where(rad_l ge 1.05)))
       if keyword_set(ajuste_awsom_bajo) then begin
          Tmmean(ileg) =  mean(Tm_l(where(rad_l le 1.05)))
       endif
    endif else begin
...
;===== TERCIOS =====
    ...
    if  keyword_set(awsom) then begin ; La idea es considerar tercios sobre 1.05
       rr1 = 1.10
       rr2 = 1.13
       lefts  = (where(rad_l ge 1.05 and rad_l le rr1))
       rights = (where(rad_l ge rr2))
       diomes = (where(rad_l gt rr1 and rad_l lt rr2))
    endif
...
;    if lefts eq -1 or diomes eq -1 or rights eq -1 then goto,skipfitloop_open
   ...
   ;de 1.05 entonces partimos el ajuste en 2
    if keyword_set(awsom) then begin
       xfit = rad_l(where(rad_l ge 1.05))
       yfit =  Ne_l(where(rad_l ge 1.05))
       if keyword_set(ajuste_awsom_bajo) then begin
          xfit = rad_l(where(rad_l le 1.05))
          yfit =  Ne_l(where(rad_l le 1.05))
       endif
    endif else begin
       xfit = rad_l
       yfit =  Ne_l
...
;-----
   ...
   ;Make HS-fit to p(r) for each open leg/loop    
         if keyword_set(awsom) then begin
            yfit =  p_l(where(rad_l ge 1.05))
            if keyword_set(ajuste_awsom_bajo) then begin
               yfit =  P_l(where(rad_l le 1.05))
            endif
         endif else begin
            yfit =  p_l
         endelse
   ...
   ;Make LINEAR-fit to T(r) for each open leg/loop
           yfit = Tm_l
     if keyword_set(awsom) then begin
       yfit =  Tm_l(where(rad_l ge 1.05))
       if keyword_set(ajuste_awsom_bajo) then begin
          yfit =  Tm_l(where(rad_l le 1.05))
       endif
    endif else begin
       yfit =  Tm_l
    endelse
...
fitTemp_ts2,xfit,yfit,rminhs,rmaxhs,a1,b1,corr4
     ...
     if keyword_set(awsom) then begin
       xfit =  s_l(where(rad_l ge 1.05))
       if keyword_set(ajuste_awsom_bajo) then begin
          xfit = s_l(where(rad_l le 1.05))
       endif
    endif else begin
       xfit =  s_l
    endelse
...
if not keyword_set(ajuste_awsom_bajo) then begin
...
;    Tmmean(ileg)   = mean(Tm_l1) ;modificado por diego 05/04/2018
...
;============= modificaciones para awsom model 
     if keyword_set(awsom) then begin
        Tmmean(ileg)   =  mean(Tm_l1(where(rad_l1 ge 1.05)))
        Tmmean(ileg+1) =  mean(Tm_l2(where(rad_l2 ge 1.05)))
        if keyword_set(ajuste_awsom_bajo) then begin
           Tmmean(ileg)   =  mean(Tm_l1(where(rad_l1 le 1.05)))
           Tmmean(ileg+1) =  mean(Tm_l2(where(rad_l2 le 1.05)))
        endif
     endif else begin
...
rrr_min = 1.035;agregado 11/03/2018 (no se xq faltaba esto lpm)
if r_max1 ge 1.2 then begin  ;igual que las piernas baiertas                                                                               

    rr1_l1 = 1.07;(max(rad_l1)-1.)*0.25 +1.0                                              
    rr2_l1 = 1.12;(max(rad_l1)-1.)*0.5 +1.0                                      
    if keyword_set(awsom) then begin
       lefts_l1  = where(rad_l1 le rr1_l1 and rad_l1 ge 1.05)
    endif else begin 
...
if r_max2 ge 1.2 then begin
    ...
    rr2_l2 = 1.12;(max(rad_l2)-1.)*0.5 +1.0                                             
    if keyword_set(awsom) then begin
       lefts_l2  = where(rad_l2 le rr1_l2 and rad_l2 ge 1.05)
    endif else begin
    ...
    Drr = max(rad_l2) - 1.035 ;se asume un pto en 1.035          
...
;HS-fit to Ne(r)
  if keyword_set(awsom) then begin
     ...
     if keyword_set(ajuste_awsom_bajo) then begin
        xfit = rad_l1(where(rad_l1 le 1.05))
        yfit =  Ne_l1(where(rad_l1 le 1.05))
     endif
  endif else begin
     xfit = rad_l1
     yfit =  Ne_l1
...
;------
  ...
  ;HS-fit to P(r)
  if keyword_set(awsom) then begin
     yfit =  p_l1(where(rad_l1 ge 1.05))
     if keyword_set(ajuste_awsom_bajo) then begin
        yfit =  P_l1(where(rad_l1 le 1.05))
     endif
  endif else begin
     yfit =  p_l1
  endelse
  ...
  if keyword_set(awsom) then begin
     ...
     if keyword_set(ajuste_awsom_bajo) then begin
        yfit =  Tm_l1(where(rad_l1 le 1.05))
     endif
  endif else begin
     yfit =  Tm_l1
  endelse
...
if keyword_set(awsom) then begin
   xfit = s_l1(where(rad_l1 ge 1.05))
   if keyword_set(ajuste_awsom_bajo) then begin
      xfit = s_l1(where(rad_l1 le 1.05))
   endif
endif else begin
   xfit = s_l1
endelse
...
if opcls(il) eq 1. then begin
 ...
 ; linear-fit to T(s) ==================================
      xfit = s_l1 *rsun   ;para ver AWSOM habria que cambiar esto para r>1.05    
   ...
   if keyword_set(fitcuadr) then begin ;tambien esto habria que cambiarlo para ver AWSOM
...
;fits for leg2-------------------------------------- 
  ...
  if keyword_set(awsom) then begin
     ...
     if keyword_set(ajuste_awsom_bajo) then begin
        xfit = rad_l2(where(rad_l2 le 1.05))
        yfit =  Ne_l2(where(rad_l2 le 1.05))
     endif
  endif else begin
     xfit = rad_l2
     yfit =  Ne_l2
...
;---
  ...
  ;HS-fit to P(r)
    ...
    if keyword_set(awsom) then begin
       yfit =  p_l2(where(rad_l2 ge 1.05))
       if keyword_set(ajuste_awsom_bajo) then begin
          yfit =  P_l2(where(rad_l2 le 1.05))
       endif
    endif else begin
       yfit =  p_l2
    endelse
  ...
  ;HS-fit to T(r)  
     if keyword_set(awsom) then begin
        ...
        if keyword_set(ajuste_awsom_bajo) then begin
           yfit =  Tm_l2(where(rad_l2 le 1.05))
        endif
     endif else begin
        yfit =  Tm_l2
     endelse
...
;------------------------------------------------
xfit=s_l2
if keyword_set(awsom) then begin ;esto no se si esta ok.
     xfit = s_l2(where(rad_l2 ge 1.05))
     if keyword_set(ajuste_awsom_bajo) then begin
        xfit = s_l2(where(rad_l2 le 1.05))
     endif 
  endif else begin
     xfit = s_l2
  endelse
...
pro histoplot2_full,data1,data2,min=min,max=max,nbins=nbins,xtit=xtit,ytit=ytit,tit=tit,filename=filename,ndig=ndig
;la idea es tener un histoplot que overplotee 2 datos
;cualesquiera. 09/04/2018
ps1,'./newfigs/histoplot2_full'+filename+'.eps',0
!p.charsize=2
DEVICE,/INCHES,YSIZE=5,XSIZE=10,SCALE_FACTOR=1, FONT_INDEX=4
f1 = histogram(data1,min=min,max=max,nbins=nbins,locations=vbin1) & f1 = f1 / total(f1)
f2 = histogram(data2,min=min,max=max,nbins=nbins,locations=vbin2) & f2 = f2 / total(f2)
maxy=max([f1,f2])
plot,vbin1,f1,psym=10,xtitle=xtit,ytitle=ytit,title=tit,yr=[0,maxy],xstyle=1,/nodata,thick=5,charthick=2.25,Font=0,charsize=2.5
loadct,12
verde = 25
azul =100
rojo =200
...
;oplot,vbin1,f1,psym=10,th=5,color=verde
oplot,vbin2,f2,psym=10,th=5,color=azul
loadct,0

avg1        =  mean(data1);rojo
avg2        =  mean(data2);azul
med1        = median(data1)
med2        = median(data2)
cant1       = long(n_elements(data1))
cant2       = long(n_elements(data2))
...
xyouts,.98-[.4,.3,.2,.1],0.82*[1,1,1,1],['m','!9m!3','!9s!3/!9m!3','N'],/normal,charthick=2,Font=0
loadct,12
xyouts,0.95-[.4,.3,.2,.1],0.76*[1,1,1,1],[strmid(string(med1),5,ndig),strmid(string(avg1),5,ndig),strmid(string(stdev1),4,ndig),strmid(string(cant1),7,7)],/normal,color=[rojo,rojo,rojo,rojo],charthick=2,charsize=2.3,Font=0
xyouts,0.95-[.4,.3,.2,.1],0.7*[1,1,1,1],[strmid(string(med2),5,ndig),strmid(string(avg2),5,ndig),strmid(string(stdev2),4,ndig),strmid(string(cant2),7,7)],/normal,color=[azul,azul,azul,azul],charthick=2,charsize=2.3,Font=0
xyouts,0.3*[1,1],[0.76,0.7],['AWSoM','DEMT'],/normal,color=[rojo,azul],charthick=2,charsize=2.3,Font=0
loadct,0
ps2
return
end
