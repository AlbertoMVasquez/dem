...
ldemfile='LDEM.v3.error_box.1915.eit.l0.75075_gauss1_lin_Norm-median_singlStart'

ldemfiles=['LDEM.v3.error_box.1915.eit.HLL.l1.15_oreg075_gauss1_lin_Norm-median_singlStart',$
           'LDEM.v3.error_box.1915.eit.LHH.l1.15_oreg075_gauss1_lin_Norm-median_singlStart',$
           'LDEM.v3.error_box.1915.eit.LHL.l1.15_oreg075_gauss1_lin_Norm-median_singlStart',$
           'LDEM.v3.error_box.1915.eit.HLH.l1.15_oreg075_gauss1_lin_Norm-median_singlStart',$
           'LDEM.v3.error_box.1915.eit.LLH.l1.15_oreg075_gauss1_lin_Norm-median_singlStart',$
           'LDEM.v3.error_box.1915.eit.HHL.l1.15_oreg075_gauss1_lin_Norm-median_singlStart',$
           'LDEM.v3.error_box.1915.eit.HLL.l0.35_ureg075_gauss1_lin_Norm-median_singlStart',$
           'LDEM.v3.error_box.1915.eit.LHH.l0.35_ureg075_gauss1_lin_Norm-median_singlStart',$
           'LDEM.v3.error_box.1915.eit.LHL.l0.35_ureg075_gauss1_lin_Norm-median_singlStart',$
...
;    Ersat(ZDA)=0. ;<---
 ...
 if CNS(0) ne -1 then begin
    Nesat(CNS)=0.
    Tmsat(CNS)=0.;Tmmax*1.e6
  endif

;  display_carrmap,R,ir,2*Nband,scalefactor,1.,superlow,superhigh,12,'R @ '+strmid(suffix,0,5)+' Rsun'+'  '+strmid(suffix,32,8),instrument ;,/log
;  record_gif,'/data1/work/dem/newfigs/','R_'+suffix+'.gif';,'X'

; display_carrmap,Nesat/1.e8,ir,2*Nband+1,scalefactor,1.,0.,Nemax,4,'Ne [10!U8!Ncm!U-3!N] @ '+strmid(suffix,0,5)+' Rsun'+'  '+strmid(suffix,32,8),instrument
; record_gif,'/data1/work/dem/newfigs/','Ne_'+suffix+'.gif';,'X'

; display_carrmap,Tmsat/1.e6,ir,2*Nband+2,scalefactor,1.,0.,Tmmax,5,'Tm [MK] @'+strmid(suffix,0,5)+' Rsun'+'  '+strmid(suffix,32,8),instrument
