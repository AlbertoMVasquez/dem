...
histoplot3,xx1,xx2,xx3,min=mini,max=maxi,nbins=nbins,xtit='Ner [B1.035,G1.075,R1.115]',ytit='Frequency Histogram',tit='QS low reg closed small loops',filename='QS-low-reg-Ner-035-075-115'+suffix
...
nbins=80
footpoint_map,[lat1_loop_c,lat2_loop_c],[lon1_loop_c,lon2_loop_c],[opclstat_loop_c,opclstat_loop_c],filelabel='QS-high-reg'+suffix,indexloop_c,rotacion
...
histoplot3,xx1,xx2,xx3,min=mini,max=maxi,nbins=nbins,xtit='Ner [B1.035,G1.075,R1.115]',ytit='Frequency Histogram',tit='QS high reg closed small loops',filename='QS-high-reg-Ner-035-075-115'+suffix

Ne_basal_crit = 1.4e8

;Loop en lat [10.40] lon ge 60
 i = where(lat1_loop le 40. AND lat1_loop ge 10. AND lat2_loop le 40. AND lat2_loop ge 10. AND lon1_loop ge 60. AND lon2_loop ge 60. and Ner21_loop/1.e8 ge 1.4 and Ner22_loop/1.e8 ge 1.4)
filter_loop,i

nbins=80
footpoint_map,[lat1_loop_c,lat2_loop_c],[lon1_loop_c,lon2_loop_c],[opclstat_loop_c,opclstat_loop_c],filelabel='AR-high'+suffix,indexloop_c,rotacion
...
histoplot3,xx1,xx2,xx3,min=mini,max=maxi,nbins=nbins,xtit='Ner [B1.035,G1.075,R1.115]',ytit='Frequency Histogram',tit='AR closed small loops',filename='AR-Ner-035-075-115'+suffix
...
;QS
 Ncrit = 1.2
 i = where(Ner21_loop/1.e8 le Ncrit and Ner22_loop/1.e8 le Ncrit AND Phir_loop gt 0.)
filter_loop,i
...
maxi=4.;max(xx)                                                                                                                                     
histoplot3,xxr,xxf,xxh,min=mini,max=maxi,nbins=nbins,xtit='!9f!3 [10!U5!N erg cm!U-2!N sec!U-1!N]',ytit='Frequency Histogram',$
tit='QS closed small loops',filename='QS-Phis'+suffix
...
mini=0.;min(xx1)
maxi=3.;max(xx1)                                                                                                                                                      
histoplot3,xx1,xx2,xx3,min=mini,max=maxi,nbins=nbins,xtit='Ner [B1.035,G1.075,R1.115]',ytit='Frequency Histogram',tit='QS closed small loops',filename='QS-Ner-035-075-115'+suffix

;AR
 Ncrit  = 1.2
 i = where(Ner21_loop/1.e8 ge Ncrit and Ner22_loop/1.e8 ge Ncrit)
filter_loop,i
