FUNCTION  ROBUST_LINEFIT,XIN,YIN,YFIT,SIG,SS, NUMIT=THIS_MANY, BISECT=TYPE, Bisquare_Limit=Bisquare_Limit,Close_Factor=Close_Factor
;+
; NAME:
;       ROBUST_LINEFIT
;
...
;    Now calculate the equation of the bisector of the 2 lines:
  ...
  ENDELSE
  CC=[YINT,SLOP] 
  ISTAT=ROB_CHECKFIT(YP,YFIT,EPS,DEL,  SIG,FRACDEV,NGOOD,W,S,Bisquare_Limit=Bisquare_Limit )
