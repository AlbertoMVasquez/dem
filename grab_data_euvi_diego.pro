...
pro explore
  ...
  grab_data_euvi_diego,'2009-03-09','2009-04-05','/data1/work/Minimum_2009_diego/','data_cr2081_diego',/graf,/A
  grab_data_euvi_diego,'2017-03-06','2017-02-04','/data1/work/Minimum_2017_diego/','data_cr2189_diego',/graf,/A
  
return
end

pro grab_data_euvi_diego,date1,date2,basedir,filename,graf=graf,A=A,B=B
...
if keyword_set(A) then begin
 ...
 if keyword_set(graf) then begin
     graph_data,basedir,filename,/A
     print,'plot of the data generated in '+basedir+filename
 endif
endif
...
pro graph_data,basedir,filename,A=A,B=B
common metainfo,A171,A195,A284,A304,B171,B195,B284,B304
