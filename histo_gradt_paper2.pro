...
;se activa si quiero guardar algo, sino solo muestra en pantalla
  ...
  if not keyword_set(v6) then begin
     oplot,vbin1,f1,psym=10,thick=7,color=cyan,linestyle=0
     oplot,vbin2,f2,psym=10,thick=7,color=azul,linestyle=0
     oplot,vbin3,f3,psym=10,thick=7,color=rojo,linestyle=0
