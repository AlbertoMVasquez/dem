...
dlon = 2. + fltarr(Nrad)
   ...
   period = '2081_euviA-DECON_DEBUG_reg0.75_safety0.5_radstart-1.035-1.215Rs_unifgrid_v2.heating.sampled.v2.DIEGO'
   ;period = '2081_euvi_nodecon_errorbox_base_testeando_endemoniados_loops'
   ;period ='2081_euviA-NODECON_reg0.75_safety0.5_errorbox_base_radstart-1.035-1.215Rs'
...
; if opcls(il) eq 1. and max(rad_v(*,il)) le (Rmax_tom - dr_tom/2) then begin 
;xxx=xxx+1
;print, 'puto loop -->',il
;endif
