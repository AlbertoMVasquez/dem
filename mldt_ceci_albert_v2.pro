;----
;Solo hace footpoint_map
pro test_albert;,filelabel=filelabel
...
common starttrace,strad,stlat,stlon,footrad,footlat,footlon
 ...
 filelabel = ''
 fileT = 'traceLDEM_CR2081_euviA-NODECON_reg0.75_safety0.5_radstart-1.035-1.215Rs_unifgrid_v2.heating.sampled.v2.ALBERT.dat'
;fileT = 'traceLDEM_CR1915_EIT_reg0.75_safety0.5_grid0.5_albert_radstart-1.035-1.215Rs_unifgrid_v2.heating.sampled.v2.DIEGO.dat'

 statloop,fileT,rloopmin=1.05,/linear
...
pro test,thebox,ind=ind,onefile=onefile;,filelabel=filelabel
...
filesT = ['traceLDEM_CR2081_euviA-DECON_reg0.75_safety1.0_expand_radstart-1.045Rs_unifgrid.heating.sampled.v2.CECI.dat',$
...
rstart      = [1.045,1.075,1.115,1.155,1.250,1.500]

filesT = ['traceLDEM_CR2081_euviA-DECON_reg0.75_safety1.0_grid0.5_crap_radstart-1.055-1.135Rs_unifgrid_v2.heating.sampled.v2.ALBERT.dat']
rstart      = 1.055+0.02*findgen(5)

filesT = ['traceLDEM_CR2081_euviA-DECON_reg0.75_safety1.0_grid0.5_crap_radstart-1.035-1.215Rs_unifgrid_v2.heating.sampled.v2.ALBERT.dat']
rstart      = 1.035+0.02*findgen(10)

fileT = 'traceLDEM_CR2081_euviA-NODECON_reg0.75_safety0.5_radstart-1.035-1.215Rs_unifgrid_v2.heating.sampled.v2.ALBERT.dat'

fileT = 'traceLDEM_CR2099_aia4_reg0.75_safety0.5_grid0.5_radstart-1.035-1.215Rs_unifgrid_v2.heating.sampled.v2.DIEGO.dat'
fileT = 'traceLDEM_CR2099_aia3_reg0.75_safety0.5_grid0.5_radstart-1.035-1.215Rs_unifgrid_v2.heating.sampled.v2.DIEGO.dat'
fileT = 'traceLDEM_CR2099_euviA_reg1.0_safety0.5_grid0.5_radstart-1.035-1.215Rs_unifgrid_v2.heating.sampled.v2.DIEGO.dat'

if not keyword_set (altura) then altura =0.
if     keyword_set (altura) then altura = n_elements(rstart)

filelabel = 'DIEGO_CRAP2'
latmax    = thebox(0)
latmin    = thebox(1)
lonmax    = thebox(2)
lonmin    = thebox(3)
...
if marker_ind(i) eq 0 then goto,lainsoportablelevedad
   ...
   read_trace_sampled,filesT(i),altura
...
analisis2:
;==========================================Analisis piernas 2=================
;-------------------Piernas abiertas en caja

    open_leg = where(opclstat eq 0)
   Nopen_leg = n_elements(open_leg)
    flatopen = footlat
    flonopen = footlon
   _flatopen = flatopen ( where ( opclstat eq 0 and flatopen le latmax and flatopen gt latmin and flonopen le flonmax and flonopen gt flonmin) )
   Lopen_box = n_elements (_flatopen)

;------------------Piernas cerradas largas
...
fdips_file='fdips_field_150x180x360_synop_Mr_0.polfil.2099.ubdat'
 ldem_file='LDEM.v3_CR2099_l0.75_chianti.ioneq_sun_coronal_1992_feldman_ext.abund_AIA4_FULLCORONA-ALBERT_256_corregido_gauss2FW_lin_Norm-median_singlStart'
   period ='2099_aia4_reg0.75_safety0.5_grid0.5'
trace_LDEM,fdips_file=fdips_file,ldem_file=ldem_file,period=period,safety=.5,stepmax=3000,/unifgrid_v2,dlat=dlat,dlon=dlon,radstart=radstart,/dgfw

goto,deAuna

fdips_file='fdips_field_150x180x360_synop_Mr_0.polfil.2099.ubdat'
 ldem_file='LDEM.v3_CR2099_l0.75_chianti.ioneq_sun_coronal_1992_feldman_ext.abund_AIA3_FULLCORONA-ALBERT_171_corregido_gauss1_lin_Norm-median_singlStart'
   period ='2099_aia3_reg0.75_safety0.5_grid0.5'
trace_LDEM,fdips_file=fdips_file,ldem_file=ldem_file,period=period,safety=.5,stepmax=3000,/unifgrid_v2,dlat=dlat,dlon=dlon,radstart=radstart
 ...
 fdips_file='fdips_field_150x180x360_synop_Mr_0.polfil.2099.ubdat'
 ldem_file ='LDEM.v3_cr2099_l1.0_chianti.ioneq_sun_coronal_1992_feldman_ext.abund_euvi.A_L171_NODECON_gauss1_lin_Norm-median_singlStart'
   period ='2099_euviA_reg1.0_safety0.5_grid0.5'
trace_LDEM,fdips_file=fdips_file,ldem_file=ldem_file,period=period,safety=.5,stepmax=3000,/unifgrid_v2,dlat=dlat,dlon=dlon,radstart=radstart
...
fdips_file='fdips_field_150x180x360_synop_Mr_0.polfil.1915.ubdat'
 ldem_file='LDEM.v3_cr1915_l0.75_masked_chianti.ioneq_sun_coronal_1992_feldman_ext.abund_crap_L171_gauss1_lin_Norm-median_singlStart'
   period ='1915_EIT_reg0.75_safety0.5_grid0.5_albert'
trace_LDEM,fdips_file=fdips_file,ldem_file=ldem_file,period=period,safety=.5,stepmax=3000,/unifgrid_v2,dlat=dlat,dlon=dlon,radstart=radstart;,/expand              
...
ldem_file ='LDEM.v3_cr2081_l0.75_chianti.ioneq_sun_coronal_1992_feldman_ext.abund_euvi.A_L171_DECON_gauss1_lin_Norm-median_singlStart'
   period ='2081_euviA-DECON_reg0.75_safety1.0_grid0.5_crap'

  period= '2099_aia3_reg0.75_safety0.5_grid0.5'
  ldem_file='LDEM.v3_CR2099_l0.75_chianti.ioneq_sun_coronal_1992_feldman_ext.abund_AIA3_FullCorona_192_corregido_gauss1_lin_Norm-median_singlStart'
 fdips_file='fdips_field_150x180x360_synop_Mr_0.polfil.2099.ubdat'
trace_LDEM,fdips_file=fdips_file,ldem_file=ldem_file,period=period,safety=.5,stepmax=3000,/unifgrid_v2,dlat=dlat,dlon=dlon,radstart=radstart;,/expand  
loqueestaba:
...
; Make the output filename:
  ...
  output_file='traceLDEM_CR'+period+suffix+'.heating.sampled.v2.DIEGO.dat' ;<-- le agrego CECI para que salga con otro nombre
...
; Compute the scoreR for quality-selection purposes:
 ...
 ;scoreR=total(    (1.-ratio)^2 , 4 ) / float(nband)
  ...
  Nptmax_v = 150
  if keyword_set(expand) then Nptmax_v = 1500                ; ESTO NO ES ROBUSTO, 
...
pro read_trace_sampled,file;altura
  common trace_sampled,rad_v,lat_v,lon_v,s_v,Ne_v,Tm_v,WT_v,Er_v,scoreR_v,midcell_v,Npts_v,str_v,stth_v,stph_v,radstart,enrad_v,enlon_v,enlat_v,npar,DEMc_v,lambda_v,L,Tmin,Tmax
  common B_sampled,B_v,Br_v,Bth_v,Bph_v
  common opclstatus,opcls,loopL,WTc  
;+
...
if not keyword_set(altura) then read_trace_sampled,file
;if     keyword_set(altura) then read_trace_sampled,file,altura
...
r2Tcuadr_v2 = fltarr(Nlegs)-555. ;<--- agregado mistico para ajustes cuadrados en temp (experimental)
      Eh = fltarr(Nlegs)-555.
...
; and they do it correctly independently of the switching status:
  ...
  p1 = where ( rad_l1 ge rmin and rad_l1 le rmax and Ne_l1 ne -999. and scoreR_l1 lt 0.1)
  p2 = where ( rad_l2 ge rmin and rad_l2 le rmax and Ne_l2 ne -999. and scoreR_l2 lt 0.1)
...
;<-- AGREGADO
 fitcuadrTemp_v2,xfit,yfit,rminhs,rmaxhs,A,corr2,T0s1,dTmds(ileg)*rsun
 Acuadr1_v2 = A
r2Tcuadr_v2(ileg) = corr2
...
Er_l1_base  =  Er_l1
Er_l2_rev   =  reverse(Er_l2)
Er_l2_base  =  Er_l2_rev
...
xfit = ss_l1
yfit = Er_l1_base
fithsEr,xfit,yfit,A,r2

Er_l1_r0 = A[0] * exp( -A[1]*(1.-1./r0) )
...
;stop
    ...
    Er_l2_e = [Er_l2_r0,Er_l1]

     phir_l1 = int_tabulated(s_l1_e,Er_l1_e) ; flujo radiaivo ;<---
  phir(ileg) = phir_l1                                    ;<--
     phir_l2 = int_tabulated(s_l2_e,Er_l2_e) ; flujo radiaivo ;<---
phir(ileg+1) = phir_l2                                    ;<---
;stop
...
; if opcls(il) gt 0 AND footlat(ileg)*footlat(ileg+1) lt 0. AND abs(footlat(ileg)) le 30. AND abs(footlat(ileg+1)) le 30.  then goto,grafica
...
; diferents plots for leg1
 ...
 !p.charsize=1.5 
  ...
  plot,s_l1,tm_l1/1.e6,psym=4,title='Tm(s)-leg1 cuadr (experimental'
  oplot,X,(Acuadr1_v2[0]*(X)^2 + Acuadr1_v2[1]*(X) + Acuadr1_v2[2])/1.e6
  xyouts,0.5*[1],(1./2)*1.-[.35],[string(r2Tcuadr_v2(ileg))],/normal
...
; plots for leg2
 ...
 xyouts,0.5*[1,1,1],(2./3)*1.-[.1,.125,.15],[string(P0(ileg+1)),string(lambda_p(ileg+1)),string(r2p(ileg+1))],/normal
  ...
  plot,s_l2,tm_l2/1.e6,psym=4,title='Tm(s)-leg2 cuadr (experimental)'
  oplot,X,(Acuadr2_V2[0]*(X)^2 + Acuadr2_v2[1]*(X) + Acuadr2_v2[2])/1.e6
  xyouts,0.5*[1],(1./2)*1.-[.35],[string(r2Tcuadr_v2(ileg+1))],/normal
...
PRO function_hs, X, A, F, pder
   F = A[0] * exp( -A[1]*(1.-1./X) )
   IF N_PARAMS() GE 4 then pder=[ [F/A[0]] , [F*(1./X-1.)] ]
END
...
pro fitcuadrTemp_v2,rr,yy,Rmin,Rmax,A,r2,T0,gradT
p=where(rr ge Rmin and rr le Rmax)
rr=rr(p)
yy=yy(p)
A2 = yy(0)
A1 = gradT
A0 = A1*A1 / (max(yy)-A2)* (-2.)
A=[A0,A1,A2]
ww=yy*0.+1.
fit=curvefit(rr,yy,ww,A,Sigma,function_name='function_cuadr')
meanyy= mean(yy)
