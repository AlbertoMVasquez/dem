...
i = where(gradT ne -555. AND opclstat eq 2. and r2N gt r2crit_N and abs(footlat) le 30.)
filter,i
...
histoplot,     Ne0_c/1.e8,min=0,max=5.0,nbins=100,xtit='N!De0!N [10!U8!Ncm!U-3!N]',ytit='Frequency Histogram',tit='Low latitude closed small loops '+suffix,filename='low-lat-small_histo_Ne0'+suffix

; piernas de loops chicos con pie en el rango de abs(latitud) (30,90]
i = where(gradT ne -555. AND opclstat eq 2. and r2N gt r2crit_N and abs(footlat) gt 30.)
filter,i
...
histoplot,     Ne0_c/1.e8,min=0,max=5.0,nbins=100,xtit='N!De0!N [10!U8!Ncm!U-3!N]',ytit='Frequency Histogram',tit='Mid latitude closed small loops '+suffix,filename='mid-lat-small_histo_Ne0'+suffix

; piernas de loops grandes
i = where(gradT ne -555. AND opclstat eq 1. and r2N ge r2crit_N)
filter,i
...
histoplot,     Ne0_c/1.e8,min=0,max=5.0,nbins=100,xtit='N!De0!N [10!U8!Ncm!U-3!N]',ytit='Frequency Histogram',tit='Closed Large loops '+suffix,filename='large_histo_Ne0'+suffix

; piernas de loops grandes de la O/C boundary sur
i = where(gradT ne -555. AND opclstat eq 1. and r2N ge r2crit_N and footlat lt -40.)
filter,i
...
histoplot,     Ne0_c/1.e8,min=0,max=5.0,nbins=100,xtit='N!De0!N [10!U8!Ncm!U-3!N]',ytit='Frequency Histogram',tit='Closed large loops O/C South '+suffix,filename='large-OCS_histo_Ne0'+suffix

; piernas de loops grandes de la O/C boundary norte
i = where(gradT ne -555. AND opclstat eq 1. and r2N ge r2crit_N and footlat gt +40.)
filter,i
...
histoplot,     Ne0_c/1.e8,min=0,max=5.0,nbins=100,xtit='N!De0!N [10!U8!Ncm!U-3!N]',ytit='Frequency Histogram',tit='Closed large loops O/C South '+suffix,filename='large-OCN_histo_Ne0'+suffix

; piernas de lineas abiertas del polo sur 
i = where(gradT ne -555. AND opclstat eq 0. and r2N ge r2crit_N and footlat lt -50.)
filter,i
...
histoplot,     Ne0_c/1.e8,min=0,max=5.0,nbins=100,xtit='N!De0!N [10!U8!Ncm!U-3!N]',ytit='Frequency Histogram',tit='Open south loops '+suffix,filename='open-south_histo_Ne0'+suffix

; piernas de lineas abiertas del polo norte 
i = where(gradT ne -555. AND opclstat eq 0. and r2N ge r2crit_N and footlat gt +50.)
filter,i
...
histoplot,     Ne0_c/1.e8,min=0,max=5.0,nbins=100,xtit='N!De0!N [10!U8!Ncm!U-3!N]',ytit='Frequency Histogram',tit='Open north loops '+suffix,filename='open-north_histo_Ne0'+suffix
