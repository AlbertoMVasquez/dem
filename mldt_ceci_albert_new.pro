pro compamin,ind=ind,filelabel=filelabel
...
common statistic_loops3,Eh,sH,r2sH,Phir,Fcb,Ner0
...
common stat_filter2,opclstat_c,lambda_N_c,lambda_p_c,Ne0_c,p0_c,Tefit_c,gradT_c,r2N_c,r2P_c,r2T_c,indexloop_c,leg_status_c,Tm0_c,Tm0s_c  
common stat_filter3,Eh_c,sH_c,r2sH_c,Phir_c,Fcb_c,Ner0_c
common stat_filter4,r2Tcuadr_c,Acuadr_a_c, s_r0_a_c,dTmds_c,r2Ts_c
common stat_filter5,strad_c,stlat_c,stlon_c,footrad_c,footlat_c,footlon_c 
common stat_filter6,r2Er_c,Phirfit_c

common loops,Phir_loop,rad1_loop,rad2_loop,lat1_loop,lat2_loop,lon1_loop,lon2_loop,L_loop,opclstat_loop,r2Er1_loop,r2Er2_loop,Tmmean_loop,Fcb_loop,dTmds1_loop,dTmds2_loop,r2Tcuadr1_loop,r2Tcuadr2_loop,r2T1_loop,r2T2_loop,Ner01_loop,Ner02_loop
common loops_filter,Phir_loop_c,rad1_loop_c,rad2_loop_c,lat1_loop_c,lat2_loop_c,lon1_loop_c,lon2_loop_c,L_loop_c,opclstat_loop_c,r2Er1_loop_c,r2Er2_loop_c,Tmmean_loop_c,Fcb_loop_c,dTmds1_loop_c,dTmds2_loop_c,r2Tcuadr1_loop_c,r2Tcuadr2_loop_c,r2T1_loop_c,r2T2_loop_c,Ner01_loop_c,Ner02_loop_c
...
;filesT = ['traceLDEM_CR2081_euviA-DECON_reg0.75_safety0.5_radstart-1.035-1.215Rs_unifgrid_v2.heating.sampled.v2.ALBERT.dat']
 ...
 filesT = ['traceLDEM_CR1915_EIT_reg0.75_safety0.5_grid0.5_albert_radstart-1.035-1.215Rs_unifgrid_v2.heating.sampled.v2.DIEGO.dat',$
           'traceLDEM_CR2081_euviA-NODECON_reg0.75_safety0.5_radstart-1.035-1.215Rs_unifgrid_v2.heating.sampled.v2.ALBERT.dat']
 nf=2
 ...
 ; CH-SUR--------------------------------------------------------------------------------
 statloop,filesT[0],rloopmin=1.05,/linear;,/fitcuadr
 i = where(gradT ne -555. AND opclstat eq 0. and footlat ge -80. and footlat lt  0. and r2N gt r2crit_N and footlon le 180.)
 filter,i
 lambda_N_c_1=lambda_N_c
  Nebasal_c_1=Ner0_c
   Tmmean_c_1=Tmmean_c
    Bmean_c_1=Bmean_c
      Br0_c_1=Br0_c

 statloop,filesT[1],rloopmin=1.05,/linear;,/fitcuadr
 i = where(gradT ne -555. AND opclstat eq 0. and footlat ge -80. and footlat lt 0. and r2N gt r2crit_N)
 filter,i
 lambda_N_c_2=lambda_N_c
  Nebasal_c_2=Ner0_c
   Tmmean_c_2=Tmmean_c
    Bmean_c_2=Bmean_c
      Br0_c_2=Br0_c

 tit='Southern Coronal Hole'
 nbins=50
;histoplot2,lambda_N_c_1     ,lambda_N_c_2     ,min=0.04,max=0.15,nbins=nbins,xtit='!9l!3!DN!N [R!DSUN!N]'         ,ytit='Frequency Histogram',tit=tit,filename='comparacion-CH-S_lambda_N',ndig=5
;histoplot2, Nebasal_c_1/1.e8, Nebasal_c_2/1.e8,min=0.25,max=2.00,nbins=nbins,xtit='Ne0 [10!U8!Ncm!U-3!N]',ytit='Frequency Histogram',tit=tit,filename='comparacion-CH-S_Nebasal' ,ndig=6
;histoplot2,  Tmmean_c_1/1.e6,  Tmmean_c_2/1.e6,min=0.50,max=1.50,nbins=nbins,xtit='Te [MK]'                   ,ytit='Frequency Histogram',tit=tit,filename='comparacion-CH-S_Te'    ,ndig=6
 histoplot2,  Br0_c_1        ,Br0_c_2          ,min=0.00,max=15  ,nbins=nbins,xtit='B!D0!N [Gauss]'                ,ytit='Frequency Histogram',tit=tit,filename='comparacion-CH-S_B0'      ,ndig=6 
...
; Streamer with low B --------------------------------------------------------------------------------
 statloop,filesT[0],rloopmin=1.05,/linear;,/fitcuadr
 i = where(gradT ne -555. AND opclstat gt 0. and r2N gt r2crit_N and footlon le 180. and Br0 le 2)
 filter,i
 lambda_N_c_1=lambda_N_c
  Nebasal_c_1=Ner0_c
   Tmmean_c_1=Tmmean_c
 ...
 statloop,filesT[1],rloopmin=1.05,/linear;,/fitcuadr
 i = where(gradT ne -555. AND opclstat gt 0. and r2N gt r2crit_N and Br0 le 2)
 filter,i
 lambda_N_c_2=lambda_N_c
  Nebasal_c_2=Ner0_c
   Tmmean_c_2=Tmmean_c
 ...
 nbins=50
 tit='Equatorial Streamer with Low |B|'
;histoplot2,lambda_N_c_1     ,lambda_N_c_2     ,min=0.04,max=0.14,nbins=nbins,xtit='!9l!3!DN!N [R!DSUN!N]'         ,ytit='Frequency Histogram',tit=tit,filename='comparacion-Streamer_lambda_N-lowB',ndig=5
;histoplot2, Nebasal_c_1/1.e8, Nebasal_c_2/1.e8,min=0.75,max=2.50,nbins=nbins,xtit='N!De!N basal [10!U8!Ncm!U-3!N]',ytit='Frequency Histogram',tit=tit,filename='comparacion-Streamer_Nebasal-lowB' ,ndig=6
;histoplot2,  Tmmean_c_1/1.e6,  Tmmean_c_2/1.e6,min=0.75,max=2.00,nbins=nbins,xtit='T!De!N [MK]'                   ,ytit='Frequency Histogram',tit=tit,filename='comparacion-Streamer_Te-lowB'    ,ndig=6
 histoplot2,  Br0_c_1        ,Br0_c_2          ,min=0.00,max=2.00,nbins=nbins,xtit='B!D0!N [Gauss]'                ,ytit='Frequency Histogram',tit=tit,filename='comparacion-Streamer_B0-lowB'      ,ndig=6 

stop

; Streamer--------------------------------------------------------------------------------
 statloop,filesT[0],rloopmin=1.05,/linear;,/fitcuadr
 i = where(gradT ne -555. AND opclstat gt 0. and r2N gt r2crit_N and footlon le 180.)
 filter,i
 lambda_N_c_1=lambda_N_c
  Nebasal_c_1=Ner0_c
   Tmmean_c_1=Tmmean_c
 ...
 statloop,filesT[1],rloopmin=1.05,/linear;,/fitcuadr
 i = where(gradT ne -555. AND opclstat gt 0. and r2N gt r2crit_N)
 filter,i
 lambda_N_c_2=lambda_N_c
  Nebasal_c_2=Ner0_c
   Tmmean_c_2=Tmmean_c
 ...
 nbins=50
 tit='Equatorial Streamer'
 histoplot2,lambda_N_c_1     ,lambda_N_c_2     ,min=0.04,max=0.14,nbins=nbins,xtit='!9l!3!DN!N [R!DSUN!N]'         ,ytit='Frequency Histogram',tit=tit,filename='comparacion-Streamer_lambda_N',ndig=5
 histoplot2, Nebasal_c_1/1.e8, Nebasal_c_2/1.e8,min=0.75,max=2.50,nbins=nbins,xtit='Ne0 [10!U8!Ncm!U-3!N]',ytit='Frequency Histogram',tit=tit,filename='comparacion-Streamer_Nebasal' ,ndig=6
 histoplot2,  Tmmean_c_1/1.e6,  Tmmean_c_2/1.e6,min=0.75,max=2.00,nbins=nbins,xtit='Te [MK]'                   ,ytit='Frequency Histogram',tit=tit,filename='comparacion-Streamer_Te'    ,ndig=6
 histoplot2,  Br0_c_1        ,Br0_c_2          ,min=0.00,max=10  ,nbins=nbins,xtit='B!D0!N [Gauss]'                ,ytit='Frequency Histogram',tit=tit,filename='comparacion-Streamer_B0'      ,ndig=6 



; CHs--------------------------------------------------------------------------------
 statloop,filesT[0],rloopmin=1.05,/linear;,/fitcuadr
 i = where(gradT ne -555. AND opclstat eq 0. and abs(footlat) le 80. and r2N gt r2crit_N and footlon le 180.)
 filter,i
 lambda_N_c_1=lambda_N_c
  Nebasal_c_1=Ner0_c
   Tmmean_c_1=Tmmean_c
 ...
 statloop,filesT[1],rloopmin=1.05,/linear;,/fitcuadr
 i = where(gradT ne -555. AND opclstat eq 0. and abs(footlat) le 80. and r2N gt r2crit_N)
 filter,i
 lambda_N_c_2=lambda_N_c
  Nebasal_c_2=Ner0_c
   Tmmean_c_2=Tmmean_c
 ...
 tit='Coronal Holes'
 nbins=50
 histoplot2,lambda_N_c_1     ,lambda_N_c_2     ,min=0.04,max=0.15,nbins=nbins,xtit='!9l!3!DN!N [R!DSUN!N]'         ,ytit='Frequency Histogram',tit=tit,filename='comparacion-CHs_lambda_N',ndig=5
 histoplot2, Nebasal_c_1/1.e8, Nebasal_c_2/1.e8,min=0.25,max=2.00,nbins=nbins,xtit='N!De!N basal [10!U8!Ncm!U-3!N]',ytit='Frequency Histogram',tit=tit,filename='comparacion-CHs_Nebasal' ,ndig=6
 histoplot2,  Tmmean_c_1/1.e6,  Tmmean_c_2/1.e6,min=0.50,max=1.50,nbins=nbins,xtit='T!De!N [MK]'                   ,ytit='Frequency Histogram',tit=tit,filename='comparacion-CHs_Te'    ,ndig=6
 histoplot2,  Br0_c_1        ,Br0_c_2          ,min=0.00,max=15  ,nbins=nbins,xtit='B!D0!N [Gauss]'                ,ytit='Frequency Histogram',tit=tit,filename='comparacion-CHs_B0'      ,ndig=6 
...
;record_gif,'./','cambio_Ne_rstart_distintos.gif','X'
  ...
  statloop,filesT(i),rloopmin=1.05,/linear;,/fitcuadr
...
if max(s_l1) lt s_l1_max * rsun then begin   
    ...
    Er_l1_e_fit = A[0] * exp( A[1] * [r0,rad_l1,r_l1_max] )
...
if max(s_l1) eq s_l1_max * rsun then begin   
    ...
    Er_l1_e = [Er_l1_r0,Er_l1]
     B_l1_e = [ B_l1_r0, B_l1]
    Er_l1_e_fit = A[0] * exp( A[1] * [r0,rad_l1] )
...
if max(s_l2) lt s_l2_max * rsun then begin   
    ...
    Er_l2_e_fit = A[0] * exp( A[1] * [r_l2_max,rad_l2,r0] )
...
if max(s_l2) eq s_l2_max * rsun then begin   
    ...
    Er_l2_e = [Er_l2,Er_l2_r0] ;<---
     B_l2_e = [ B_l2, B_l2_r0] ;<---
    Er_l2_e_fit = A[0] * exp( A[1] * [rad_l2,r0] )
...
; if footlat(ileg)*footlat(ileg+1) lt 0. AND abs(footlat(ileg)) ge 60. AND abs(footlat(ileg+1)) ge 60. then goto,grafica
...
plot,vbin,f,psym=10,charsize=2,th=2,xtitle=xtit,ytitle=ytit,title=tit

avg        =  mean(data)
stdev_frac = stdev(data)/avg
...
pro create_data_structure,data
...
data = CREATE_STRUCT('Tmmean_c',Tmmean_c,'loop_length_c',loop_length_c,'Bmean_c',Bmean_c,'opclstat_c',opclstat_c,'lambda_N_c',lambda_N_c,'r2N_c',r2N,$
                      'footlat_c',footlat_c,'footlon_c',footlon_c,'r2T_c',r2T_c,'Ner0_c',Ner0_c)
