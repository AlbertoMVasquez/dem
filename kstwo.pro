...
; EXPLANATION:
;       Returns the Kolmogorov-Smirnov statistic and associated
;       probability 
;       that two arrays of data values are drawn from the same
;       distribution
...
;              level of
;               the K-S statistic.   Small values of PROB show that
;               the 
;               cumulative distribution function of DATA1 is
;               significantly 
;               different from DATA2
;
; EXAMPLE:
;       Test whether two vectors created by the RANDOMN function
;       likely came
;       from the same distribution
;
;       IDL> data1 = randomn(seed,40)        ;Create data vectors to
;       be 
...
;       FP computation of N_eff      H. Ebeling/W. Landsman  March
;       1996
;       Fix for arrays containing equal values J. Ballet/W. Landsman
;       Oct. 2001
;       Fix index when maximum difference is at array end Renbin Yan
;       Dec 2008
;       Handle large number when computing N_err  D. Schnitzeler/WL
;       Sep 2010
;-
  On_error, 2
  compile_opt idl2 
